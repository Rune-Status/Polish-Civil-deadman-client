...
public final class MidiFile extends Node {
  ...
  public void method516() {
    if (this.aClass130_2564 == null) {
      ...
      int[] var2 = new int[16];
      var1[9] = var2[9] = 128;
      SomethingMidiFile0 var3 = new SomethingMidiFile0(
          this.aByteArray2565);
      ...
      while (true) {
        ...
        while (var3.anIntArray1114[var5] == var6) {
          ...
          if (var8 == 144) {
            ...
            if (var11 > 0) {
              int var12 = var2[var9];
              SomethingMidiFile var13 = (SomethingMidiFile) this.aClass130_2564.get(
                  var12);
              if (var13 == null) {
                var13 = new SomethingMidiFile(new byte[128]);
                this.aClass130_2564.put(var12, var13);
              }
  ...
  public static MidiFile method517(FileUnpacker unpacker, int fileId, int childId) {
