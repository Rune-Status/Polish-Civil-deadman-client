...
public final class WaterShader implements MaterialShader {
  ...
  public void enable() {
    if (this.anInt2186 >= 0) {
      ...
      GlRenderer.GL.glTranslatef(BZipDecompressorState.anInt144, ClientScript.anInt3695,
          StringNode.anInt2587);
      GlRenderer.GL
      ...
      if (!SomethingGl.aBoolean1227) {
        GlRenderer.GL.glBindTexture(3553,
          SomethingGl.anIntArray1224[(int) ((GlRenderer.anInt1791 * 64) * 0.0050F) % 64]);
      }
      ...
      if (this.anInt2182 != GlRenderer.anInt1791) {
        ...
        for (int var3 = 0; var3 < 64; ++var3) {
          ...
          GlRenderer.GL.glProgramLocalParameter4fvARB('\u8620', var3,
        ...
        if (SomethingGl.aBoolean1227) {
          GlRenderer.GL
              .glProgramLocalParameter4fARB('\u8620', 65, GlRenderer.anInt1791 * 0.0050F,
            0.0F, 0.0F, 1.0F);
        } else {
          GlRenderer.GL
              .glProgramLocalParameter4fARB('\u8620', 65, 0.0F, 0.0F, 0.0F, 1.0F);
        }
  ...
  public void set(int var1) {
    if (this.anInt2186 >= 0) {
      GlRenderer.GL.glActiveTexture('\u84c1');
      if ((var1 & 128) == 0) {
        GlRenderer.GL.glEnable(SomethingGl.aBoolean1227 ? '\u806f' : 3553);
      } else {
        GlRenderer.GL.glDisable(SomethingGl.aBoolean1227 ? '\u806f' : 3553);
      }

      GlRenderer.GL.glActiveTexture('\u84c0');
      if ((var1 & 64) == 0) {
        GlRenderer.GL.glGetFloatv(2899, WaterShader.aFloatArray2185, 0);
        GlRenderer.GL.glProgramLocalParameter4fvARB('\u8620', 66,
            WaterShader.aFloatArray2185, 0);
      } else {
        GlRenderer.GL
            .glProgramLocalParameter4fARB('\u8620', 66, 1.0F, 1.0F, 1.0F, 1.0F);
      }

      int var3 = var1 & 3;
      if (var3 == 2) {
        GlRenderer.GL
            .glProgramLocalParameter4fARB('\u8620', 64, 0.05F, 1.0F, 1.0F, 1.0F);
      } else if (var3 == 3) {
        GlRenderer.GL
            .glProgramLocalParameter4fARB('\u8620', 64, 0.1F, 1.0F, 1.0F, 1.0F);
      } else {
        GlRenderer.GL
            .glProgramLocalParameter4fARB('\u8620', 64, 0.025F, 1.0F, 1.0F, 1.0F);
      }
  ...
  private void method1749() {
    ...
    GlRenderer.GL.glTexEnvi(8960, '\u8588', '\u8578');
    GlRenderer.GL.glActiveTexture('\u84c0');
    GlRenderer.GL.glBindProgramARB('\u8620', this.anInt2184);
    GlRenderer.GL.glEnable('\u8620');
    ...
    GlRenderer.GL.glDisable(SomethingGl.aBoolean1227 ? '\u806f' : 3553);
    GlRenderer.GL.glActiveTexture('\u84c0');
    GlRenderer.GL.glBindProgramARB('\u8620', 0);
    GlRenderer.GL.glDisable('\u8620');
    GlRenderer.GL.glDisable('\u8804');
    GlRenderer.GL.glEndList();
  }
  ...
  private void method1750() {
    if (this.anInt2186 >= 0) {
      int[] var2 = new int[1];
      GlRenderer.GL.glBindProgramARB('\u8620', this.anInt2184);
      GlRenderer.GL.glProgramStringARB('\u8620', '\u8875',
