...
public final class DummyClass16 {
  ...
  private static void method2034(SoftwareIndexedColorSprite var0,
    ...
    if (var7 > 0 && var6 > 0) {
      DummyClass16
          .method2044(var1.aByteArray2674, var0.aByteArray2674, var5, var4,
              var7, var6, var8, var9);
      DummyClass16.method2036(var2, var3, var7, var6);
    }
  }
  ...
  private static void method2036(int var0, int var1, int var2, int var3) {
    ...
    for (int var8 = var4; var8 <= var5; ++var8) {
      for (int var9 = var6; var9 <= var7; ++var9) {
        DummyClass16.blockShadows[var8][var9].needsUpdate = true;
      }
    }
      ...
      if (!var2 || var0 != 1) {
        if (!var3 || var0 != 0) {
          ...
          if (var0 != 0 && var0 != 1 && (var2 || var3)) {
            DummyClass16
                .method2050(DummyClass16.floorShadows[var0],
                    DummyClass16.shadowsSprite, var13 + 1, var14 + 1, var1,
                    var2);
          } else {
            DummyClass16.method2034(DummyClass16.floorShadows[1],
                DummyClass16.shadowsSprite, var13 + 1, var14 + 1);
          }
        }
      }
    }
  ...
  public static void drawShadows(int var0, int var1, int var2,
    ...
    for (int blockX = 0; blockX < DummyClass16.sceneWidthBlocks; ++blockX) {
      int blockY = 0;
      while (blockY < DummyClass16.sceneHeightBlocks) {
        int var9 = blockX * 8;
        while (true) {
          if (var9 < blockX * 8 + 8) {
            label42:
              ...
              if (var9 - var0 >= -var2 && var9 - var0 <= var2) {
                for (int var10 = blockY * 8; var10 < blockY * 8 + 8; ++var10) {
                  if (var10 - var1 >= -var2 && var10 - var1 <= var2 && var4[
                      var9 - var0 + var2][
                      var10 - var1 + var2]) {
                    BlockShadowMap shadows = DummyClass16.blockShadows[blockX][blockY];
                    if (shadows.needsUpdate) {
                      shadows
                          .update(DummyClass16.shadowsSprite, blockX, blockY);
  ...
  private static boolean method2039(byte[] var0, int var1, int var2, int var3,
      int var4,
      int var5) {
    int var6 = var2 % var5;
    int var7;
  ...
  private static boolean method2040(SoftwareIndexedColorSprite var0,
      SoftwareIndexedColorSprite var1, int var2, int var3) {
    var2 += var0.offsetX;
    var3 += var0.offsetY;
    int var4 = var2 + var3 * var1.width;
    ...
    if (var6 > 0 && var5 > 0) {
      ...
      DummyClass16.method2036(var2, var3, var6, var5);
      return DummyClass16
  ...
  public static void initializeShadows(int var0, int var1) {
    DummyClass16.sceneWidthBlocks = var0 + 7 >> 3;
    DummyClass16.sceneHeightBlocks = var1 + 7 >> 3;
    DummyClass16.shadowsSprite =
        new SoftwareIndexedColorSprite(DummyClass16.sceneWidthBlocks * 128 + 2,
            DummyClass16.sceneHeightBlocks * 128 + 2, 0);
    DummyClass16.blockShadows = new BlockShadowMap[DummyClass16.sceneWidthBlocks][DummyClass16.sceneHeightBlocks];

    for (int var2 = 0; var2 < DummyClass16.sceneWidthBlocks; ++var2) {
      for (int var3 = 0; var3 < DummyClass16.sceneHeightBlocks; ++var3) {
        DummyClass16.blockShadows[var2][var3] = new BlockShadowMap();
      }
    }
  ...
  public static void method2043() {
    DummyClass16.shadowsSprite = null;
    DummyClass16.floorShadows = null;
    DummyClass16.blockShadows = null;
  }
  ...
  private static void method2046(byte[] var0, byte[] var1, int var2, int var3,
      int var4,
      int var5, int var6) {
  ...
  public static void method2047(SoftwareIndexedColorSprite var0, int var1,
    ...
    if (var0 != null) {
      ...
      DummyClass16
          .method2042(var0, DummyClass16.shadowsSprite, var4 + 1, var5 + 1);
    }
  }

  private static void method2048(byte[] var0, byte[] var1, int var2, int var3,
      int var4,
      int var5, int var6) {
    for (int var7 = -16; var7 < 0; ++var7) {
      for (int var8 = -4; var8 < 0; ++var8) {
  ...
  public static boolean method2049(SoftwareIndexedColorSprite var0, int var1,
    ...
    if (var0 == null) {
      ...
      int var5 = var3 - (var2 * GlEnvironment.anInt1315 >> 8) >> 3;
      return DummyClass16
          .method2040(var0, DummyClass16.shadowsSprite, var4 + 1, var5 + 1);
    }
  }
  ...
  private static void method2050(SoftwareIndexedColorSprite var0,
    ...
    if (var2 > 0 && var3 > 0 && var2 + 16 < var1.width
      ...
      DummyClass16.method2036(var2, var3, 16, 16);
    }
  }
  ...
  public static void method2051(SoftwareIndexedColorSprite var0, int var1,
    ...
    if (var0 != null) {
      ...
      int var5 = var3 - (var2 * GlEnvironment.anInt1315 >> 8) >> 3;
      DummyClass16
          .method2034(var0, DummyClass16.shadowsSprite, var4 + 1, var5 + 1);
    }
  }
}
