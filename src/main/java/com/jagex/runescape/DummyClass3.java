...
public final class DummyClass3 {
  ...
  static {
    for (int var0 = 0; var0 < 4096; ++var0) {
      DummyClass3.anIntArray52[var0] = Something3d2.method2246((byte) 83, var0);
    }
    ...
    HashTable var12 = new HashTable(128);
      ...
      for (var13 = 1; var13 <= 102; ++var13) {
        for (var14 = 1; ~var14 >= -103; ++var14) {
          ...
          if (~(var9[var13][var14] & 255) != -1
              || ~var16 != -1 && ~var8[var13][var14] == -1) {
            var58 = 0;
            int var60 = 0;
            var21 = 0;
            var65 = 0;
      ...
      for (var13 = 1; var13 <= 102; ++var13) {
        for (var14 = 1; ~var14 >= -103; ++var14) {
          ...
          if (~(var9[var13][var14] & 255) != -1 || ~var58 != -1 &&
              var8[var13][var14] == 0) {
            int[] var64 = new int[8];
            var65 = 0;
            int var61 = 0;
            ...
            if (var25 != 0 && var58 != var25) {
              ...
              if (var76.aBoolean2092 && ~var76.anInt2103 != 0) {
                var21 =
