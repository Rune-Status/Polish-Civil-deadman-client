...
public class GlobalStatics_8 {
    ...
    public static GameString aClass94_957 = aClass94_948;
    ...
    public static GameString aClass94_1415 = GameStringStatics.create("Loaded input handler");
    public static GameString aClass94_1409 = aClass94_1415;
    ...
    public static GameString aClass94_34 = GameStringStatics
        .create("flash2:");
    public static GameString aClass94_36 = aClass94_34;
    public static GameString aClass94_32 = aClass94_34;
    ...
    public static GameString aClass94_2751 = aClass94_2731;
    public static GameString aClass94_2740 = aClass94_2731;
    public static GameString aClass94_2739 = GameStringStatics.create("Drop");
    public static GameString OPTION_DROP = aClass94_2739;
    ...
    public static GameString aClass94_4 = aClass94_5;
    ...
    public static void method1224(Widget var0, int var1, int var2, int var3) {
      if (var0.aByte162 == 0) {
        ...
        if (GlobalStatics_9.aBoolean1040 && (method44(var0).anInt2205 != 0
          || (var0.anInt187 == 0))) {
          if ((var0.anInt210 < 0)) {
            var0.anInt210 = 0;
    ...
    public static void method1225(int var0) {
      Mouse var1 = GlobalStatics_9.INSTANCE;
        synchronized (var1) {
          ...
          GlobalStatics_9.anInt3644 = anInt2743;
    ...
    public static void method2270(Mobile var0, byte var1) {
      if (GlobalStatics_4.updateCycle == var0.anInt2790 || (var0.animationId == -1)
          || var0.anInt2828 != 0 || (1 + var0.anInt2760) > method45(var0.animationId,
    ...
    public static Widget method2273(Widget var0, int var1) {
      if (var1 < 57) {
        ...
        if (var0.anInt190 == -1) {
          ...
          HashTableIterator var4 = new HashTableIterator(GlobalStatics_10.aClass130_3208);
      ...
      if (var1 <= 68) {
        ...
        while ((var7 < var9)) {
          ...
          if (var10 >= 0) {
            ...
            var24 = var2 - var9;
            var16 = var2 + var9;
            if ((DummyClass13.anInt2020 <= var16) && (GlobalStatics_9.anInt902 >= var24)) {
              if ((var9 >= var8)) {
                ...
                if ((GlobalStatics_9.anInt902 >= var16)) {
                  GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var16], var18, -53,
                    var17, var4);
                }

                if (var24 >= DummyClass13.anInt2020) {
                  GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var24], var18, 96, var17,
                    var4);
                }
              } else {
          ...
          if ((DummyClass13.anInt2020 <= var16) && (GlobalStatics_9.anInt902 >= var24)) {
            ...
            if (var17 >= DummyClass55.anInt1425 && (GlTexture2d.anInt3765 >= var18)) {
              ...
              var18 = DummyClass59.method1040(GlTexture2d.anInt3765, var18, (byte) 0,
                DummyClass55.anInt1425);
              if (var7 < var8) {
                var19 = var11 >= var7 ? var11 : GlobalStatics_9.anIntArray1838[var7];
                ...
                if ((GlobalStatics_9.anInt902 >= var16)) {
                  GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var16], var18, 94, var17,
                    var4);
                }

                if (var24 >= DummyClass13.anInt2020) {
                  GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var24], var18, 126,
                    var17, var4);
                }
              }
            }
    ...
    public static void method2278(int var0) {
      boolean var1 = false;
        ...
        while (!var1) {
          ...
          for (int var2 = 0; (var2 < (-1 + GlobalStatics_10.amountContextActions)); ++var2) {
            if (GlobalStatics_10.aShortArray3095[var2] < 1000
              ...
              GlobalStatics_9.aClass94Array2935[var2] = GlobalStatics_9.aClass94Array2935[var2 + 1];
              ...
              GlobalStatics_10.aShortArray3095[var2] = GlobalStatics_10.aShortArray3095[1 + var2];
              GlobalStatics_10.aShortArray3095[var2 + 1] = var6;
              long var7 = GlobalStatics_9.aLongArray3271[var2];
              GlobalStatics_9.aLongArray3271[var2] = GlobalStatics_9.aLongArray3271[var2 + 1];
    ...
    public static void method1605(int var0, GameString var1, int var2) {
      ++SomethingSceneI.anInt421;
        GlobalStatics_9.secureBuffer.writePacket(188);
        GlobalStatics_9.secureBuffer.method790(var2, var0 - 13326);
        if (var0 == 255) {
          GlobalStatics_9.secureBuffer.writeLong(var1.toBase37());
        }
    }
      ...
      if ((var1 >= 0)) {
        ...
        if (var4 == 31) {
          ...
          if (var8 != null) {
            ...
            GlobalStatics_9.secureBuffer.writePacket(71);
        ...
        if ((var4 == 46)) {
          ...
          GlobalStatics_9.secureBuffer.writePacket(247);
          GlobalStatics_9.secureBuffer
              .writeShortLE(-1, GlobalStatics_9.anInt1152 + var3);
          GlobalStatics_9.secureBuffer
        ...
        if ((var4 == 40)) {
          GlobalStatics_9.secureBuffer.writePacket(27);
          GlobalStatics_9.secureBuffer.writeShort(DummyClass31.anInt1473);
          ++GlobalStatics_9.anInt1776;
          GlobalStatics_9.secureBuffer.method785(var3, (byte) -122);
          GlobalStatics_9.secureBuffer.writeShortLE(-1, var2);
          GlobalStatics_9.secureBuffer
        ...
        if ((var4 == 58)) {
          GlobalStatics_9.secureBuffer.writePacket(135);
          GlobalStatics_9.secureBuffer.method783(var5, -268435456);
          ++GlobalStatics_10.anInt3255;
          GlobalStatics_9.secureBuffer.method783(var2, -268435456);
          GlobalStatics_9.secureBuffer.method759(-68, var3);
          GlobalStatics_6.anInt2330 = 0;
          GlobalStatics_5.aClass11_1933 = GlobalStatics_7
        ...
        if ((var4 == 42)) {
          DummyClass8.method2224((byte) 39, var6, var3, var2);
          GlobalStatics_9.secureBuffer.writePacket(254);
          GlobalStatics_9.secureBuffer
              .writeShortLE(-1, var2 + GlobalStatics_10.anInt1716);
          ++GlobalStatics_9.anInt3248;
          GlobalStatics_9.secureBuffer
              .method783((int) (var6 >>> 32) & Integer.MAX_VALUE,
                  -268435456);
          GlobalStatics_9.secureBuffer
              .writeShort(var3 + GlobalStatics_9.anInt1152);
        }
        ...
        if ((var4 == 45)) {
          ...
          if (var11 != null) {
            ...
            GlobalStatics_7.anInt2958 = 0;
            GlobalStatics_7.anInt4062 = DummyClass36.anInt2614;
            GlobalStatics_9.secureBuffer.writePacket(239);
            GlobalStatics_9.secureBuffer
        ...
        if (var4 == 18) {
          if (GlobalStatics_5.gameId == 1) {
            ...
            var14 = GlobalStatics_9
                .method582(GlobalStatics_9.localPlayer.waypointsY[0], 0, 0, false,
                    ...
                    GlobalStatics_9.localPlayer.waypointsX[0]);
            if (!var14) {
              GlobalStatics_9.method582(GlobalStatics_9.localPlayer.waypointsY[0], 0, 1,
                  false, 0, 2, var2,
          ...
          GlobalStatics_9.secureBuffer
              .writeShortLE(-1, GlobalStatics_10.anInt1716 + var2);
          GlobalStatics_9.secureBuffer.writeShort(var5);
          GlobalStatics_9.secureBuffer
              .method765(var3 + GlobalStatics_9.anInt1152, (byte) 3);
        }

        if (var4 == 1001) {
          ++GlobalStatics_10.anInt1896;
          DummyClass8.method2224((byte) 39, var6, var3, var2);
          GlobalStatics_9.secureBuffer.writePacket(170);
          GlobalStatics_9.secureBuffer
        ...
        if ((var4 == 1006)) {
          ...
          if (var13 != null && (var13.anIntArray317[var2] >= 100000)) {
            printMessage(GlobalStatics_9.EMPTY_STRING, 0,
          ...
          if ((var5 == 0)) {
            ...
            if ((var5 == 1)) {
              if (GlobalStatics_10.rights > 0
                  && aBooleanArray1490[82]
                  && aBooleanArray1490[81]) {
                GlobalStatics_6.method979(GlobalStatics_10.anInt1716 + var2,
                    GlobalStatics_9.anInt1152 + var3,
                    GlobalStatics_9.currentPlane, (byte) -4);
              } else if (GlobalStatics_9
                  .method582(GlobalStatics_9.localPlayer.waypointsY[0], 0, 0, true,
                      0,
                      2, var2, 0, 0, 1, var3,
                      GlobalStatics_9.localPlayer.waypointsX[0])) {
                ...
                GlobalStatics_9.secureBuffer.writeByte(GlobalStatics_9.anInt3020);
                GlobalStatics_9.secureBuffer.writeByte(89);
                GlobalStatics_9.secureBuffer
        ...
        if (var4 == 1007) {
          ...
          if (var11 != null) {
            ...
            if (var9 != null) {
              ...
              GlobalStatics_9.secureBuffer.writePacket(72);
              GlobalStatics_9.secureBuffer.writeShort(var9.anInt1284);
            }
          }
        }

        if ((var4 == 47)) {
          GlobalStatics_9.secureBuffer.writePacket(156);
          GlobalStatics_9.secureBuffer.method765(var2, (byte) 3);
          GlobalStatics_9.secureBuffer.method783(var5, -268435456);
          GlobalStatics_9.secureBuffer.method785(var3, (byte) -120);
          GlobalStatics_6.anInt2330 = 0;
          GlobalStatics_5.aClass11_1933 = GlobalStatics_7
        ...
        if ((var4 == 3)) {
          GlobalStatics_9.secureBuffer.writePacket(253);
          ++GlobalStatics_9.anInt555;
          GlobalStatics_9.secureBuffer
              .method785(GlobalStatics_9.anInt872, (byte) -126);
          GlobalStatics_9.secureBuffer.method765(var2, (byte) 3);
          GlobalStatics_9.secureBuffer.method785(var3, (byte) -124);
          GlobalStatics_9.secureBuffer.method783(var5, -268435456);
          GlobalStatics_9.secureBuffer
        ...
        if (var4 == 49) {
          ...
          DummyClass8.method2224((byte) 39, var6, var3, var2);
          GlobalStatics_9.secureBuffer.writePacket(84);
          GlobalStatics_9.secureBuffer
              .method765(Integer.MAX_VALUE & (int) (var6 >>> 32),
                  (byte) 3);
          GlobalStatics_9.secureBuffer
              .method765(GlobalStatics_9.anInt1152 + var3, (byte) 3);
          GlobalStatics_9.secureBuffer
              .writeShortLE(var0 - 2598, var2 + GlobalStatics_10.anInt1716);
        }

        if ((var4 == 23)) {
          ++GlobalStatics_6.anInt1886;
          GlobalStatics_9.secureBuffer.writePacket(206);
          GlobalStatics_9.secureBuffer.method783(var5, -268435456);
          GlobalStatics_9.secureBuffer.writeShortLE(var0 ^ -2598, var2);
          GlobalStatics_9.secureBuffer.method785(var3, (byte) -127);
          GlobalStatics_6.anInt2330 = 0;
          GlobalStatics_5.aClass11_1933 = GlobalStatics_7
        ...
        if ((var4 == 14) && DummyClass8
          ...
          GlobalStatics_9.secureBuffer.writePacket(134);
          GlobalStatics_9.secureBuffer
              .method783(GlobalStatics_10.anInt1716 + var2,
                  var0 ^ -268432859);
          GlobalStatics_9.secureBuffer.writeShort(GlobalStatics_9.anInt2050);
          GlobalStatics_9.secureBuffer
              .writeShortLE(-1, var3 + GlobalStatics_9.anInt1152);
          GlobalStatics_9.secureBuffer.writeShort(DummyClass31.anInt1473);
          GlobalStatics_9.secureBuffer
        ...
        if ((var4 == 5)) {
          GlobalStatics_9.secureBuffer.writePacket(55);
          GlobalStatics_9.secureBuffer.writeShortLE(-1, var5);
          GlobalStatics_9.secureBuffer.method783(var2, -268435456);
          ++GlobalStatics_10.anInt3084;
          GlobalStatics_9.secureBuffer.method775(var3, 1437452424);
          GlobalStatics_6.anInt2330 = 0;
          GlobalStatics_5.aClass11_1933 = GlobalStatics_7
        ...
        if ((var4 == 21)) {
          ...
          GlobalStatics_7.anInt2958 = 0;
          GlobalStatics_7.anInt4062 = DummyClass36.anInt2614;
          GlobalStatics_9.secureBuffer.writePacket(228);
          ++DummyClass10.anInt2085;
          GlobalStatics_9.secureBuffer.writeShort(var5);
          GlobalStatics_9.secureBuffer
              .writeShortLE(var0 ^ -2598, GlobalStatics_10.anInt1716 + var2);
          GlobalStatics_9.secureBuffer
              .method765(GlobalStatics_9.anInt1152 + var3, (byte) 3);
        }
        ...
        if (var4 == 4) {
          ...
          if (var11 != null) {
            ...
            GlobalStatics_9.secureBuffer.writePacket(148);
            GlobalStatics_9.secureBuffer.method783(var5, var0 - 268438053);
          }
        }
        ...
        if (var4 == 32) {
          ...
          if (var13 != null) {
            ...
            WidgetAccess var16 = method44(var13);
            GlobalStatics_10
          ...
          if (var4 == 35) {
            GlobalStatics_9.secureBuffer.writePacket(161);
            GlobalStatics_9.secureBuffer.method785(var3, (byte) -119);
            GlobalStatics_9.secureBuffer.method765(var5, (byte) 3);
            GlobalStatics_9.secureBuffer.method765(var2, (byte) 3);
          ...
          if (var4 == 34) {
            ...
            GlobalStatics_7.anInt4062 = DummyClass36.anInt2614;
            GlobalStatics_7.anInt2958 = 0;
            GlobalStatics_9.secureBuffer.writePacket(109);
            GlobalStatics_9.secureBuffer
                .writeShortLE(-1, var3 + GlobalStatics_9.anInt1152);
            GlobalStatics_9.secureBuffer
                .writeShort(var2 + GlobalStatics_10.anInt1716);
            GlobalStatics_9.secureBuffer.method765(var5, (byte) 3);
          }

          if ((var4 == 25)) {
            ++DummyClass1.anInt411;
            GlobalStatics_9.secureBuffer.writePacket(81);
            GlobalStatics_9.secureBuffer.method783(var2, -268435456);
            GlobalStatics_9.secureBuffer.writeShort(var5);
            GlobalStatics_9.secureBuffer.method775(var3, 1437452424);
            GlobalStatics_6.anInt2330 = 0;
          ...
          if ((var4 == 2)) {
            ...
            if (var11 != null) {
              ...
              GlobalStatics_7.anInt2958 = 0;
              GlobalStatics_9.secureBuffer.writePacket(218);
              GlobalStatics_9.secureBuffer.writeShortLE(-1, var5);
            }
          }
          ...
          int var12;
          if ((var4 == 51)) {
            GlobalStatics_9.secureBuffer.writePacket(10);
            ++GlobalStatics_6.anInt3681;
            GlobalStatics_9.secureBuffer.writeInt(var3);
          ...
          if ((var4 == 26)) {
            ...
            if (var11 != null) {
              ...
              GlobalStatics_7.anInt4062 = DummyClass36.anInt2614;
              GlobalStatics_9.anInt1053 = DummyClass5.anInt2993;
              GlobalStatics_9.secureBuffer.writePacket(115);
              GlobalStatics_9.secureBuffer
                  .method759(var0 ^ -2667, GlTexture2d.anInt3764);
              GlobalStatics_9.secureBuffer
                  .writeShortLE(-1, DummyClass31.anInt1473);
              GlobalStatics_9.secureBuffer.writeShortLE(var0 ^ -2598, var5);
              GlobalStatics_9.secureBuffer
                  .method765(GlobalStatics_9.anInt2050, (byte) 3);
            }
          }
          ...
          if (var4 == 11) {
            if ((var5 == 0)) {
              ...
              if (var5 == 1) {
                ...
                GlobalStatics_9.secureBuffer
                    .method783(var3 + GlobalStatics_9.anInt1152,
                        -268435456);
              }
            }
          }
          ...
          if (var4 == 7) {
            GlobalStatics_9.secureBuffer.writePacket(85);
            ++GlobalStatics_10.anInt3144;
            GlobalStatics_9.secureBuffer.method775(var3, 1437452424);
            GlobalStatics_9.secureBuffer.writeShort(var2);
            GlobalStatics_9.secureBuffer.method783(var5, -268435456);
            GlobalStatics_6.anInt2330 = 0;
            GlobalStatics_5.aClass11_1933 = GlobalStatics_7
          ...
          if ((var4 == 24)) {
            ...
            GlobalStatics_9.anInt1053 = DummyClass5.anInt2993;
            GlobalStatics_7.anInt2958 = 0;
            GlobalStatics_9.secureBuffer.writePacket(48);
            GlobalStatics_9.secureBuffer
                .method783(var2 + GlobalStatics_10.anInt1716, -268435456);
            GlobalStatics_9.secureBuffer.method765(var5, (byte) 3);
            GlobalStatics_9.secureBuffer
                .writeShortLE(-1, GlobalStatics_9.anInt1152 + var3);
          }
          ...
          if (var4 == 38 && DummyClass8
              .method2224((byte) 39, var6, var3, var2)) {
            GlobalStatics_9.secureBuffer.writePacket(233);
            GlobalStatics_9.secureBuffer
                .method765(var3 + GlobalStatics_9.anInt1152, (byte) 3);
            ++GlobalStatics_9.anInt3017;
            GlobalStatics_9.secureBuffer
                .method783(GlobalStatics_10.anInt1716 + var2, -268435456);
            GlobalStatics_9.secureBuffer.method765(GlobalStatics_10.anInt278, (byte) 3);
            GlobalStatics_9.secureBuffer
          ...
          if ((var4 == 13)) {
            GlobalStatics_9.secureBuffer.writePacket(6);
            GlobalStatics_9.secureBuffer.writeInt(var3);
            GlobalStatics_9.secureBuffer.method783(var2, -268435456);
            ++anInt2088;
            GlobalStatics_9.secureBuffer.writeShortLE(-1, var5);
          ...
          if (var4 == 57) {
            ...
            if (var8 != null) {
              ...
              GlobalStatics_9.anInt1053 = DummyClass5.anInt2993;
              GlobalStatics_7.anInt2958 = 0;
              GlobalStatics_9.secureBuffer.writePacket(175);
              GlobalStatics_9.secureBuffer.method783(var5, -268435456);
            }
          }
          ...
          if (var4 == 22) {
            ...
            if ((var4 == 50)) {
              ...
              DummyClass8.method2224((byte) 39, var6, var3, var2);
              GlobalStatics_9.secureBuffer.writePacket(194);
              GlobalStatics_9.secureBuffer
                  .method765(var3 + GlobalStatics_9.anInt1152, (byte) 3);
              GlobalStatics_9.secureBuffer
                  .writeShortLE(-1, GlobalStatics_10.anInt1716 + var2);
            ...
            if ((var4 == 48)) {
              ...
              GlobalStatics_9.secureBuffer.writePacket(154);
              GlobalStatics_9.secureBuffer.writeShortLE(-1, var2);
              GlobalStatics_9.secureBuffer.method775(var3, 1437452424);
              GlobalStatics_9.secureBuffer.method765(var5, (byte) 3);
              GlobalStatics_6.anInt2330 = 0;
            ...
            if (var4 == 43) {
              ...
              GlobalStatics_9.secureBuffer.writePacket(153);
              GlobalStatics_9.secureBuffer.method785(var3, (byte) -124);
              GlobalStatics_9.secureBuffer.writeShortLE(-1, var2);
              GlobalStatics_9.secureBuffer.writeShortLE(var0 - 2598, var5);
              GlobalStatics_6.anInt2330 = 0;
            ...
            if ((var4 == 39)) {
              ...
              GlobalStatics_9.secureBuffer
                  .method775(GlobalStatics_9.anInt872, 1437452424);
              GlobalStatics_9.secureBuffer
                  .writeShort(GlobalStatics_9.anInt1152 + var3);
              GlobalStatics_9.secureBuffer.method765(var5, (byte) 3);
              GlobalStatics_9.secureBuffer
                  .method765(var2 + GlobalStatics_10.anInt1716, (byte) 3);
              GlobalStatics_9.secureBuffer.writeShortLE(-1, GlobalStatics_10.anInt278);
            }

            if (var0 == 2597) {
              if ((var4 == 12)) {
                ++DummyClass18.anInt79;
                GlobalStatics_9.secureBuffer.writePacket(82);
                GlobalStatics_9.secureBuffer.writeShort(GlobalStatics_10.anInt278);
                GlobalStatics_9.secureBuffer
                    .method775(var3, 1437452424);
                GlobalStatics_9.secureBuffer.writeInt(GlobalStatics_9.anInt872);
                GlobalStatics_9.secureBuffer.method765(var2, (byte) 3);
              }
              ...
              if (var4 == 36) {
                if ((var5 == 0)) {
                  ...
                  if ((GlobalStatics_10.rights > 0)
                      && aBooleanArray1490[82]
                      && aBooleanArray1490[81]) {
                    GlobalStatics_6.method979(var2 + GlobalStatics_10.anInt1716,
                        GlobalStatics_9.anInt1152 + var3,
              ...
              if (var4 == 20) {
                ...
                GlobalStatics_9.secureBuffer.writeShort(var5);
                GlobalStatics_9.secureBuffer
                    .writeShort(GlobalStatics_10.anInt1716 + var2);
                GlobalStatics_9.secureBuffer
                    .writeShortLE(-1, GlobalStatics_9.anInt1152 + var3);
              }
    ...
    public static int method809(int var0, int y, int var2, int x, int var4) {
      ...
      if (var6 != DummyClass44.anInt932 || GlobalStatics_3.aFloat2457 != var7
          || GlobalStatics_9.aFloat3044 != var8 || var9 != GlobalStatics_10.aFloat246
          || GlobalStatics_9.anInt1345 != var10 || DummyClass22.anInt1736 != var11) {
        ...
        anInt1407 = GlobalStatics_7.fogOffset;
        GlobalStatics_10.aFloat246 = var9;
        GlobalStatics_0.anInt72 = 0;
        GlobalStatics_10.anInt4037 = sunColor;
      ...
      if (GlobalStatics_0.anInt72 < 65536) {
        ...
        GlobalStatics_7.fogOffset =
            var13 * DummyClass22.anInt1736 + var12 * anInt1407
                >> 8;
      }

      GlEnvironment
          .setSunColor(sunColor, GlobalStatics_6.ambientIntensity,
              GlobalStatics_10.diffuseIntensity, GlobalStatics_9.aFloat319);
      GlEnvironment.setFogColor(GlobalStatics_9.fogColor, GlobalStatics_7.fogOffset);
      GlEnvironment.setSunPosition(DummyClass39.sunPositionX,
          GlobalStatics_9.sunPositionY, GlobalStatics_0.sunPositionZ);
    ...
    public static void method50(Widget[] var0, int var1, int var2, int var3,
      ...
      for (int var8 = 0; var8 < var0.length; ++var8) {
        ...
        if (var9 != null && var9.anInt190 == var1 && (!var9.aBoolean233
            || var9.anInt187 == 0
            || var9.aBoolean195 || method44(var9).anInt2205 != 0
          ...
          if (!var9.aBoolean233 || var12 < var14 && var13 < var15) {
            if (var9.anInt187 == 0) {
              if (!var9.aBoolean233 && method51(var9)
            ...
            if (var9.aBoolean233) {
              ...
              if (var9.aByteArray263 != null) {
                for (var19 = 0; var19 < var9.aByteArray263.length; ++var19) {
                  if (!aBooleanArray1490[var9.aByteArray263[var19]]) {
              ...
              if (var9.aBoolean195 || var9.anInt189 != 0) {
                  ...
                  if (var9.anInt189 == 1400) {
                    ...
                    if (var18) {
                      if (aBooleanArray1490[82]
                        ...
                        int var24 =
                            DummyClass58.anInt1460 - 1 - var32 + GlobalStatics_9.anInt65;
                ...
                if (var9.anObjectArray174 != null
                    && anInt944 > var9.anInt255) {
                  if (var9.anIntArray175 != null
                      && anInt944 - var9.anInt255 <= 32) {
                    label474:
                    for (var19 = var9.anInt255; var19 < anInt944;
                        ++var19) {
    ...
    public static void method34(int var0) {
      if (GlobalStatics_9.audioOutputStream0 != null) {
        ...
        method1959(256, 2, 22050, TextureSampler17.aBoolean3184);
