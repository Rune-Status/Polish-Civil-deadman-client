...
public final class SomethingMidiI {
  ...
  private static int[] anIntArray928 = {256, 128, 86, 64};
  private static float[] aFloatArray929 = {
  ...
  public SomethingMidiI() {
    ...
    if (var1 == 1) {
      ...
      if (SomethingMidiI.anIntArray925 == null
          || SomethingMidiI.anIntArray925.length < var5) {
        SomethingMidiI.anIntArray925 = new int[var5];
        SomethingMidiI.anIntArray927 = new int[var5];
        SomethingMidiI.aBooleanArray919 = new boolean[var5];
      }
  ...
  private void method1198(int var1, int var2, int var3, int var4, float[] var5, int var6) {
    ...
    var5[var1] *= SomethingMidiI.aFloatArray929[var2];
    if (var3 > var6) {
      var3 = var6;
    }
    ...
    for (int var14 = var1 + 1; var14 < var3; ++var14) {
      ...
      var5[var14] *= SomethingMidiI.aFloatArray929[var11];
    }
  ...
  private void method1199(int var1, int var2) {
    if (var1 < var2) {
      int var3 = var1;
      int var4 = SomethingMidiI.anIntArray925[var1];
      int var5 = SomethingMidiI.anIntArray927[var1];
      boolean var6 = SomethingMidiI.aBooleanArray919[var1];

      for (int var7 = var1 + 1; var7 <= var2; ++var7) {
        int var8 = SomethingMidiI.anIntArray925[var7];
        if (var8 < var4) {
          SomethingMidiI.anIntArray925[var3] = var8;
          SomethingMidiI.anIntArray927[var3] = SomethingMidiI.anIntArray927[var7];
          SomethingMidiI.aBooleanArray919[var3] = SomethingMidiI.aBooleanArray919[var7];
          ++var3;
          SomethingMidiI.anIntArray925[var7] = SomethingMidiI.anIntArray925[var3];
          SomethingMidiI.anIntArray927[var7] = SomethingMidiI.anIntArray927[var3];
          SomethingMidiI.aBooleanArray919[var7] = SomethingMidiI.aBooleanArray919[var3];
        }
      }

      SomethingMidiI.anIntArray925[var3] = var4;
      SomethingMidiI.anIntArray927[var3] = var5;
      SomethingMidiI.aBooleanArray919[var3] = var6;
  ...
  public void method1202(float[] var1, int var2 ) {
    ...
    int var4 = SomethingMidiI.anIntArray928[this.anInt923 - 1];
    SomethingMidiI.aBooleanArray919[0] = SomethingMidiI.aBooleanArray919[1] = true;
    ...
    for (var5 = 2; var5 < var3; ++var5) {
      var6 = SomethingMidiI.method1201(SomethingMidiI.anIntArray925, var5);
      var7 = SomethingMidiI.method1203(SomethingMidiI.anIntArray925, var5);
      var8 = this.method1200(SomethingMidiI.anIntArray925[var6], SomethingMidiI.anIntArray927[var6],
          SomethingMidiI.anIntArray925[var7],
          SomethingMidiI.anIntArray927[var7], SomethingMidiI.anIntArray925[var5]);
      var9 = SomethingMidiI.anIntArray927[var5];
      int var10 = var4 - var8;
      int var12 = (var10 < var8 ? var10 : var8) << 1;
      if (var9 == 0) {
        SomethingMidiI.aBooleanArray919[var5] = false;
        SomethingMidiI.anIntArray927[var5] = var8;
      } else {
        SomethingMidiI.aBooleanArray919[var6] = SomethingMidiI.aBooleanArray919[var7] = true;
        SomethingMidiI.aBooleanArray919[var5] = true;
        if (var9 >= var12) {
          SomethingMidiI.anIntArray927[var5] =
    ...
    var5 = 0;
    var6 = SomethingMidiI.anIntArray927[0] * this.anInt923;

    for (var7 = 1; var7 < var3; ++var7) {
      if (SomethingMidiI.aBooleanArray919[var7]) {
        var8 = SomethingMidiI.anIntArray925[var7];
        var9 = SomethingMidiI.anIntArray927[var7] * this.anInt923;
    ...
    float var13 = SomethingMidiI.aFloatArray929[var6];
  ...
  public boolean method1205() {
    ...
    if (var1) {
      ...
      for (var3 = 0; var3 < var2; ++var3) {
        SomethingMidiI.anIntArray925[var3] = this.anIntArray921[var3];
      }

      var3 = SomethingMidiI.anIntArray928[this.anInt923 - 1];
      int var4 = MonoChromaticImageBuffer.method513(var3 - 1, 4);
      SomethingMidiI.anIntArray927[0] = MidiInstrument.method368(var4);
      SomethingMidiI.anIntArray927[1] = MidiInstrument.method368(var4);
      int var5 = 2;
  ...
  public static void method1204() {
    SomethingMidiI.anIntArray928 = null;
    SomethingMidiI.aFloatArray929 = null;
    SomethingMidiI.anIntArray925 = null;
    SomethingMidiI.anIntArray927 = null;
    SomethingMidiI.aBooleanArray919 = null;
  }
