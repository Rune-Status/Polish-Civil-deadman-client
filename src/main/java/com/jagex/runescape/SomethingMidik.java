...
public final class SomethingMidik {
  ...
  private final int anInt1939 = MidiInstrument.method368(16);
  ...
  public SomethingMidik() {
    this.anInt1938 = MidiInstrument.method368(24);
    this.anInt1940 = MidiInstrument.method368(24);
    this.anInt1941 = MidiInstrument.method368(24) + 1;
    this.anInt1943 = MidiInstrument.method368(6) + 1;
    this.anInt1937 = MidiInstrument.method368(8);
    ...
    for (int i = 0; i < this.anInt1943 * 8; i++) {
      this.anIntArray1942[i] = ((is[i >> 3] & 1 << (i & 0x7)) != 0 ? MidiInstrument.method368(8) : -1);
    }
  }
  ...
  public void method2112(float[] fs, int i, boolean bool ) {
    ...
    if (!bool) {
      int i_3_ = (MidiInstrument.aClass71Array2406[this.anInt1937].anInt1063);
      ...
      for (int i_6_ = 0; i_6_ < 8; i_6_++) {
        ...
        while (i_7_ < i_5_) {
          if (i_6_ == 0) {
            int i_8_ = MidiInstrument.aClass71Array2406[this.anInt1937].method1290();
