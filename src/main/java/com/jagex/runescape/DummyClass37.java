  ...
  public static void parseSceneRebuild(boolean var1) {
    StringNode.dynamicScene = var1;
      ...
      if (StringNode.dynamicScene) {
        ...
        count = 0;
        boolean var8 = false;
        if ((var5 / 8 == 48 || ~(var5 / 8) == -50) && var6 / 8 == 48) {
          var8 = true;
        }
            ...
            if (var8 && (regionY == 49 || regionY == 149 || regionY == 147
              ...
              GameClient.mapFileIds[count] =
                  TextureSampler26.maps
                      .getFileId(RenderAnimation.concat(new GameString[]{
                          GameBuffer.MAP_PREFIX,
                          SomethingScene.toString(regionX),
                          TextureSampler31.UNDERSCORE,
  ...
  public static void parseEntityUpdate(byte var0) {
    int var1;
      ...
      if (~GameString.packetId == -196) {
        ...
        if (var6 >= 0 && var7 >= 0 && ~var6 > -105 && var7 < 104) {
        ...
        if ((var3 >= 1 -1) && (var4 >= 1 -1) && var3 < 104 && var4 < 104) {
        ...
        if (~GameString.packetId == -122) {
          ...
          if ((var2 >= 1 -1) && (var3 >= 1 -1) && ~var2 > -105 && ~var3 > -105) {
            var2 = var2 * 128 - -64;
            var3 = var3 * 128 - -64;
          ...
          if ((var6 >= 1 -1) && var7 >= 0 && var6 < 104 && ~var7 > -105) {
          ...
          if (~GameString.packetId == -15) {
            ...
            var5 = SpotAnimationConfig.gameBuffer.readUnsignedShort();
            var6 = SpotAnimationConfig.gameBuffer.readUnsignedShort();
            if (var2 >= 0 && (var3 >= 1 -1) && var2 < 104 && ~var3 > -105) {
              Deque var29 =
            ...
            if (var3 >= 0 && (var4 >= 1 -1) && var3 < 104 && ~var4 > -105
              && WidgetAccess.localPlayerId != var1) {
              GroundItem var27 = new GroundItem();
              var27.anInt2930 = var5;
              var27.anInt2936 = var6;
              if (TextureSampler0.groundItems[GameWorldSomething.currentPlane][var3][var4]
                  == null) {
            ...
            if (GameString.packetId == 16) {
              ...
              if (GameString.packetId == 104) {
                ...
                if (var2 >= 0 && (var3 >= 1 -1) && var2 < 208 && var3 < 208
                    && var4 >= 0 && (var5 >= 1 -1)
                ...
                var4 = SpotAnimationConfig.gameBuffer.readUnsignedShort();
                if ((var2 >= 1 -1) && var3 >= 0 && var2 < 104 && var3 < 104) {
                  Deque var24 =
                      TextureSampler0.groundItems[GameWorldSomething.currentPlane][var2][var3];
                  if (var24 != null) {
