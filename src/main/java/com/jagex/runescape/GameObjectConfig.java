...
public final class GameObjectConfig {
  ...
  public GameObjectConfig method1685(int var1 ) {
    if (var1 != 0) {
      ...
      if (~var2 <= -1 && ~var2 > -this.anIntArray1524.length
  ...
  private Model method1686(int var1, int var2, int var3) {
    Model var4 = null;
      ...
      boolean var11;
      var11 = !(128 == this.anInt1479
          && ~this.anInt1488 == -129 && 128 == this.anInt1481);

      boolean var12;
      var12 = !(this.anInt1496 == 0 && -1 == ~this.anInt1511
          && 0 == this.anInt1534);
  ...
  public SceneShadowMap method1696(int var1, int var2, int[][] var3,
    ...
    if (var9 >= -5) {
        ...
        if (GlRenderer.useOpenGlRenderer) {
          ...
          GlModel var18 =
              var14.createCopy(3 != this.aByte1505, ~this.aByte1505 == -1, true,
                  true, true, true,
