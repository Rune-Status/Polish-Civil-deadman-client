...
public final class DummyClass51 {
  ...
  public static void method1418(int var0, FileUnpacker var1) {
    DummyClass8.aClass109_Sub1Array4027 =
        GlobalStatics_7.createSprites((byte) 65, GlobalStatics_9.runesFileId, var1);
  ...
  public static void method1419(int var0) {
    int var2 = GlobalStatics_10.anInt3395;
      ...
      GlobalStatics_8.aClass3_Sub28_Sub17_2096.method681(GlobalStatics_9.aClass94_2667, var1 + 3,
        var2 + 14, var5, -1);
      ...
      for (int var8 = 0; GlobalStatics_10.amountContextActions > var8; ++var8) {
        int var9 = (-var8 - 1 + GlobalStatics_10.amountContextActions) * 15 + var2 + 31;
        int var10 = 16777215;
      ...
      GlobalStatics_9.method1282(GlobalStatics_1.anInt1462, (byte) 107,
        GlobalStatics_10.anInt3395, GlobalStatics_9.anInt3537, GlobalStatics_9.anInt3552);
  }
  ...
  public static int getSettings() {
    return ((TextureSampler17.aBoolean3184 ? 1 : 0) << 19) + (
        ((DummyClass35.aBoolean661 ? 1 : 0) << 16) + ((!GLStatics.aBoolean1685 ? 0 : 1) << 15)
          + ((!GLStatics.useBumpMaps ? 0 : 1) << 13) + ((GlobalStatics_9.aBoolean2910 ? 1 : 0) << 10)
          + ((GlobalStatics_9.aBoolean3275 ? 1 : 0) << 9) + ((GlobalStatics_10.aBoolean236 ? 1 : 0) << 7) + (
          (!GlobalStatics_9.aBoolean488 ? 0 : 1) << 6) + ((GlobalStatics_9.aBoolean1905 ? 1 : 0) << 5) + (
