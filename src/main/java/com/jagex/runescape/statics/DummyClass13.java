...
public final class DummyClass13 {
  ...
  public static void method2195(int var0, int var1) {
    ...
    if (DummyClass12.anIntArray2026.length < GlobalStatics_9.anInt1071) {
      ...
      GlobalStatics_10
          .method215((byte) -119, DummyClass8.aClass109_Sub1Array4027[var3]);
    }
    ...
    for (var6 = 0; var5 > var6; ++var6) {
      var7 = DummyClass2.anIntArray1681[var3 + var4] -
          var0 * DummyClass12.anIntArray2026[
              -1 + DummyClass12.anIntArray2026.length
    ...
    for (var6 = 0; var2 - var0 > var6; ++var6) {
      GlobalStatics_6.anIntArray3592[var6] = GlobalStatics_6.anIntArray3592[var6
          + var0];
    }

    for (var6 = var2 - var0; var2 > var6; ++var6) {
      GlobalStatics_6.anIntArray3592[var6] =
          (int) (Math.sin(DummyClass3.anInt57 / 14.0D) * 16.0D + 14.0D * Math
              .sin(
    ...
    if ((var6 > 0)) {
      ...
      for (var7 = 0; var2 > var7; ++var7) {
        ...
        for (var10 = -var6; (var10 < 128); ++var10) {
          ...
          if (var10 >= 0) {
            GlobalStatics_8.anIntArray3805[var10 + var9] =
                var8 / (1 + var6 * 2);
          }
        }
      }
