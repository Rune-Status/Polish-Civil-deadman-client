...
public final class DummyClass41 {
  ...
  public static void method1171(int var0, int var1, int var2, int var3,
    ...
    if (var7 <= 360000) {
      ...
      if (var8 * var8 >= var7) {
        DummyClass36.method1030(var5,
            GlobalStatics_9.aClass3_Sub28_Sub16Array2690[var0],
            var4, var3, var1, (byte) 11, var2);
      } else {
        var8 -= 10;
        int var9 =
            2047 & GlobalStatics_9.anInt3102 + GlobalStatics_9.NEXT_CAMERA_YAW;
  ...
  public static void method1173(Buffer var0, int var1) {
    ...
    DummyClass26.aClass44_Sub1Array1609 =
        new GameWorld[-GlobalStatics_10.anInt3054 + GlobalStatics_8.anInt1416
            + 1];
