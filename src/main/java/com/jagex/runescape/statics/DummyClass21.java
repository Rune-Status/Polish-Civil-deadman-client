...
public final class DummyClass21 {
  ...
  public static int[][] anIntArrayArray1763 = {
      ...
      {0, 0, 64, 128, 0, 128},
      {128, 128, 64, 128, 128, 0}, {0, 0, 128, 0, 128, 128, 64, 128},
  ...
  public static void method1808(int var0, boolean var1, byte var2, int var3,
      boolean var4) {
    GlobalStatics_7
        .method1047(var0, var3,
            GlobalStatics_10.aClass44_Sub1Array3201.length - 1, var4, 0,
            var1, false);
    if (var2 != 30) {
  ...
  public static void method1809(int var0, long[] var1, int var2, int var3,
      Object[] var4) {
    if (var2 < 85) {
