...
public class GlobalStatics_7 {
  ...
  public static void rebuildScene(int plane, int var1, int var2, int y,
    ...
    if (GlobalStatics_2.anInt3606 != var2 || var1
      ...
      GlobalStatics_3
          .drawLoadingBox(GameStringStatics.LOADING_PLEASE_WAIT, true);
  ...
  public static GameString method1303(Widget var0, GameString var1, int var2) {
    if (~var1.indexOf(GameStringStatics.aClass94_468) == var2) {
      return var1;
    } else {
      while (true) {
        int var3 = var1.indexOf(GameStringStatics.aClass94_331);
        if (var3 == -1) {
          while (true) {
            var3 = var1.indexOf(GameStringStatics.aClass94_2080);
            if (var3 == -1) {
              while (true) {
                var3 = var1.indexOf(GlobalStatics_7.aClass94_1301);
                if (var3 == -1) {
                  while (true) {
                    var3 = var1.indexOf(GameStringStatics.aClass94_852);
                    if (var3 == -1) {
                      while (true) {
                        var3 = var1.indexOf(GameStringStatics.aClass94_3418);
                        if (var3 == -1) {
                          while (true) {
                            var3 = var1
                                .indexOf(GameStringStatics.aClass94_1051);
                            if (var3 == -1) {
                              return var1;
                            }

                            GameString var4 = GameStringStatics.EMPTY_STRING;
  ...
  public static void handleCommand(GameString command) {
    if (GlobalStatics_10.PLAYER_RIGHTS >= 2) {
      ...
      int var3;
      Runtime var6;
      if (command.method1531(GameStringStatics.COMMAND_GC)) {
        ...
        GlobalStatics_8
            .printMessage(null, 0, GlobalStatics_9.concat(new GameString[]{
                GameStringStatics.aClass94_3360, GlobalStatics_9.toString(var3),
                GlobalStatics_7.aClass94_2951
            }), -1);
      }

      int var4;
      if (command.method1531(GameStringStatics.aClass94_3651)) {
        GlobalStatics_10.method246(8);
      ...
      if (command.method1531(DummyClass53.aClass94_1337)) {
        ...
        GlobalStatics_9.GAME_SOCKET.method1467();
      ...
      if (command.method1531(GameStringStatics.COMMAND_WM0)) {
      ...
      if (command.method1531(GameStringStatics.COMMAND_NOCLIP)) {
      ...
      if (command.method1558(GameStringStatics.aClass94_3289, 0)
      ...
      if (command.method1558(GlobalStatics_8.COMMAND_RECTANGLE_DEBUG, 0)) {
        ...
        GlobalStatics_8
            .printMessage(null, 0, GlobalStatics_9.concat(new GameString[]{
                GameStringStatics.RECTANGLE_DEBUG_EQ,
      ...
      if (command.method1531(GameStringStatics.COMMAND_TWEEN)) {
        if (GlobalStatics_9.tweening) {
          GlobalStatics_9.tweening = false;
          GlobalStatics_8
              .printMessage(null, 0, GameStringStatics.aClass94_2061, -1);
        } else {
          GlobalStatics_9.tweening = true;
          GlobalStatics_8
              .printMessage(null, 0, GameStringStatics.FORCED_TWEENING_ENABLED,
                  -1);
        }
      }
  ...
  public static void method2100(byte var0) {
    GlobalStatics_9.GAME_BUFFER.method807((byte) 118);
    int var1 = GlobalStatics_9.GAME_BUFFER.readBits(1);
    if (var1 != 0) {
      int var2 = GlobalStatics_9.GAME_BUFFER.readBits(2);
      if (var2 == 0) {
        ...
        int var5;
        if (var2 == 1) {
          var4 = GlobalStatics_9.GAME_BUFFER.readBits(3);
          GlobalStatics_9.localPlayer.method1968(1, (byte) -128, var4);
          var5 = GlobalStatics_9.GAME_BUFFER.readBits(1);
          if (var5 == 1) {
            DummyClass60.anIntArray441[GlobalStatics_9.anInt997++] = 2047;
          }
          ...
          if (var2 == 3) {
            var4 = GlobalStatics_9.GAME_BUFFER.readBits(7);
            var5 = GlobalStatics_9.GAME_BUFFER.readBits(1);
            GlobalStatics_9.currentPlane = GlobalStatics_9.GAME_BUFFER
                .readBits(2);
            ...
            int var7 = GlobalStatics_9.GAME_BUFFER.readBits(7);
          ...
          if (GlobalStatics_9.GAME_BUFFER.readBits(1) == 1) {
            ...
            var5 = GlobalStatics_9.GAME_BUFFER.readBits(3);
          ...
          var4 = GlobalStatics_9.GAME_BUFFER.readBits(1);
          if (var4 == 1) {
            DummyClass60.anIntArray441[GlobalStatics_9.anInt997++] = 2047;
          }
