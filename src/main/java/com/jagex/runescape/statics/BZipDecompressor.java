...
import com.jagex.runescape.model.BZipDecompressorState;

public final class BZipDecompressor {

  private static BZipDecompressorState aClass9_1438 = new BZipDecompressorState();

  private static int method1633(int var0, BZipDecompressorState var1) {
    while (var1.anInt128 < var0) {
      var1.anInt140 =
          var1.anInt140 << 8 | var1.aByteArray127[var1.anInt116] & 255;
      var1.anInt128 += 8;
      ++var1.anInt116;
      ++var1.anInt147;
    }
  ...
  private static void method1634(BZipDecompressorState var0) {
  ...
  private static void method1636(BZipDecompressorState var0) {
    var0.anInt137 = 0;
  ...
  private static byte method1637(BZipDecompressorState var0) {
    return (byte) BZipDecompressor.method1633(8, var0);
  }

  private static void method1638(BZipDecompressorState var0) {
    boolean var4 = false;
    boolean var5 = false;
    boolean var6 = false;
    boolean var7 = false;
    ...
    while (var26) {
      byte var1 = BZipDecompressor.method1637(var0);
      if (var1 == 23) {
        return;
      }

      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1637(var0);
      ...
      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1637(var0);
      var1 = BZipDecompressor.method1639(var0);
      ...
      BZipDecompressor.method1636(var0);
      int var38 = var0.anInt137 + 2;
      int var39 = BZipDecompressor.method1633(3, var0);
      int var40 = BZipDecompressor.method1633(15, var0);
      var35 = 0;
      ...
      for (var37 = 0; var37 < var39; ++var37) {
        int var49 = BZipDecompressor.method1633(5, var0);
        var35 = 0;
      ...
      for (var37 = 0; var37 < var39; ++var37) {
        ...
        BZipDecompressor.method1635(var0.anIntArrayArray115[var37],
            var0.anIntArrayArray108[var37],
            var0.anIntArrayArray110[var37], var0.aByteArrayArray146[var37],
            var2, var3, var38);
      ...
      int var50;
      byte var52;
      for (var50 = BZipDecompressor.method1633(var22, var0);
          var50 > var23[var51]; var50 = var50 << 1 | var52) {
        ++var51;
        var52 = BZipDecompressor.method1639(var0);
      }
      ...
      while (var44 != var42) {
        if (var44 != 0 && var44 != 1) {
          ...
          if (var33 < 16) {
            ...
            for (var1 = var0.aByteArray109[var30 + var33]; var33 > 3;
                var33 -= 4) {
            ...
            while (var33 > 0) {
              var0.aByteArray109[var30 + var33] = var0.aByteArray109[
                  var30 + var33 - 1];
              --var33;
            }
            ...
            for (var1 = var0.aByteArray109[var30];
                var30 > var0.anIntArray123[var31]; --var30) {
            ...
            if (var0.anIntArray123[0] == 0) {
              ...
              for (var55 = 15; var55 >= 0; --var55) {
                for (var54 = 15; var54 >= 0; --var54) {
                  var0.aByteArray109[var56] = var0.aByteArray109[
                      var0.anIntArray123[var55] + var54];
                  --var56;
                }
          ...
          GlobalStatics_4.anIntArray1690[var47] =
          ...
          do {
            ...
            for (
                var50 = BZipDecompressor.method1633(var22, var0);
                var50 > var23[var51]; var50 = var50 << 1 | var52) {
              ++var51;
              var52 = BZipDecompressor.method1639(var0);
            }
          ...
          ++var46;
          var1 = var0.aByteArray114[var0.aByteArray109[var0.anIntArray123[0]]
              & 255];
      ...
      for (var35 = 0; var35 < var47; ++var35) {
        ...
        GlobalStatics_4.anIntArray1690[var0.anIntArray122[var1 & 255]] |=
            var35 << 8;
      ...
      ++var0.anInt131;
      var0.anInt121 = var47;
      BZipDecompressor.method1634(var0);
      var26 = var0.anInt131 == var0.anInt121 + 1 && var0.anInt143 == 0;
    }

  }

  private static byte method1639(BZipDecompressorState var0) {
    return (byte) BZipDecompressor.method1633(1, var0);
  }

  public static int method1640(byte[] var0, int var1, byte[] var2,
      int var4) {
    BZipDecompressorState var5 = BZipDecompressor.aClass9_1438;
    synchronized (var5) {
      BZipDecompressor.aClass9_1438.aByteArray127 = var2;
      BZipDecompressor.aClass9_1438.anInt116 = var4;
      BZipDecompressor.aClass9_1438.aByteArray117 = var0;
      BZipDecompressor.aClass9_1438.anInt118 = 0;
      BZipDecompressor.aClass9_1438.anInt126 = var1;
      BZipDecompressor.aClass9_1438.anInt128 = 0;
      BZipDecompressor.aClass9_1438.anInt140 = 0;
      BZipDecompressor.aClass9_1438.anInt147 = 0;
      BZipDecompressor.aClass9_1438.anInt141 = 0;
      BZipDecompressor.method1638(BZipDecompressor.aClass9_1438);
      var1 -= BZipDecompressor.aClass9_1438.anInt126;
      BZipDecompressor.aClass9_1438.aByteArray127 = null;
      BZipDecompressor.aClass9_1438.aByteArray117 = null;
      return var1;
    }
  }

  public static void method1641() {
    BZipDecompressor.aClass9_1438 = null;
  }
