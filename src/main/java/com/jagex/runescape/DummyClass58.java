  ...
  public static void method1652(int var0, int var1, int var2, int var3, int var4, int var5, int var6,
    ...
    if (var9 != 0) {
      ...
      if ((var5 >= DummyClass55.anInt1425) && (var5 <= GlTexture2d.anInt3765)
        ...
        && (DummyClass13.anInt2020 <= var4) && (var4 <= GlobalStatics_9.anInt902)
        && (var7 >= DummyClass13.anInt2020) && GlobalStatics_9.anInt902 >= var7
        && var2 >= DummyClass13.anInt2020 && (GlobalStatics_9.anInt902 >= var2)
        && (var3 >= DummyClass13.anInt2020) && (var3 <= GlobalStatics_9.anInt902)) {
        GlobalStatics_9.method114(3, var2, var8, var7, var6, var1, var3, var4, var0,
          var5);
      } else {
  ...
  public static GameString method1653(int var0, int var1) {
    if (var1 != 0) {
      ...
      return GlobalStatics_9.concat(new GameString[] {
        ...
        GlobalStatics_9.toString((var0 & 16712751) >> 16), DummyClass8.aClass94_4023,
  ...
  public static void loadTitleScreenSprites(FileUnpacker var0, byte var1) {
    if (!GlobalStatics_9.aBoolean2713) {
        ...
        DummyClass59.titlebackground =
          GlobalStatics_9.method1344(117, var0, DummyClass14.titleBackgroundFileId);
        ...
        GlobalStatics_3.logoSprite =
          GlobalStatics_10.createIndexedColorSprite(var0, GlobalStatics_6.logoFileId);
