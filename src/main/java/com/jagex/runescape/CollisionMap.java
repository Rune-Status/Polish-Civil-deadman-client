...
public final class CollisionMap {
            ...
            if (var8 == 0) {
              ...
              if (~var8 == -2) {
                ...
                if (~var8 == -4) {
                  ...
                  if (~var2 == ~(var5 - -1) && var1 == var4
                      && ~(19661184 & this.anIntArrayArray1304[var2][var4])
                      == -1) {
                    return true;
                  }
          ...
          if (var6 == 2) {
            if (~var8 == -1) {
              ...
              if (~var5 <= ~var2 && var9 >= var5 && -var7 + var1 == var4
                  && ~(19661058 & this.anIntArrayArray1304[var5][var10])
                  == -1) {
                return true;
              }
            } else {
              if (~var8 == -2) {
                ...
                if (~var5 <= ~var2 && ~var5 >= ~var9 && var4 == -var7 + var1
                    && ~(this.anIntArrayArray1304[var5][var10] & 19661058)
                    == -1) {
                  return true;
                }
              } else {
    ...
    if (-2 == ~var5) {
      ...
      if (~var5 == -2) {
        ...
        if (6 == var2 || var2 == 7) {
          ...
          if (~var6 == -1) {
            ...
            if (var6 == 1) {
              ...
              if (var7 <= var3 && var3 <= var9 && ~var4 == ~(var1 + 1) && 0 == (
                  32
                      & this.anIntArrayArray1304[var3][var4])) {
                return true;
              }
        ...
        if (var2 == 8) {
          ...
          return ~var7 == ~(1 + var3) && var1 >= var4 && var1 <= var10 && 0 == (
              this.anIntArrayArray1304[var7][var1] & 128);
        }
      }
        ...
        if (var7 >= var1 && var7 < var13) {
          ...
          if (~var11 == ~var1 && (var4 & 8) == 0) {
            ...
            for (var15 = var2; ~var15 > ~var12; ++var15) {
              if (-1 == ~(128 & this.anIntArrayArray1304[var7
  ...
  public boolean method1498(boolean var1, int var2, int var3, int var4,
    ...
    if (-2 > ~var5) {
        ...
        if (~var2 >= ~var4 && var10 >= var4 && var8 <= var3 && ~var3 >= ~var11) {
          ...
          return
              var2 + -1 == var4 && ~var3 <= ~var8 && var3 <= var11 && -1 == ~(
                  this.anIntArrayArray1304[-this.anInt1309
                      + var4][var3 - this.anInt1306] & 8)
                  && -1 == ~(
                  var7 & 8) || (
                  var4 == 1 + var10 && ~var8 >= ~var3 && ~var11 <= ~var3
                      && 0 == (128
                      & this.anIntArrayArray1304[var4 - this.anInt1309][-this.anInt1306
                      + var3])
                      && (var7 & 2) == 0 || (
                      ~var3 == -var8 && ~var2 >= ~var4 && var10 >= var4
                          &&
  ...
  public boolean method1500(int var1,int var2,int var3,int var4,int var5 ) {
    if (var5 == var4 && ~var2 == ~var3) {
        ...
        var4 -= this.anInt1309;
        if (0 <= var4 && this.anInt1300
            > var4 && -1 >= ~var3 && ~var3 > ~this.anInt1303) {
          var2 -= this.anInt1306;
          var5 -= this.anInt1309;
          int var6;
          if (~var4 < ~var5) {
