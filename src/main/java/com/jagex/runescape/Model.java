...
public final class Model extends SceneNode {
  ...
  public short[] aShortArray2846;
  public int[] anIntArray2847;
  public byte aByte2848;
  public int amountFaces;
  public short[] aShortArray2851;
  public byte[] aByteArray2852;
  public short[] aShortArray2855;
  public int[][] skinGroups;
  public byte[] aByteArray2857;
  public short[] materials;
  public byte[] normalTypes;
  public int[] anIntArray2860;
  public int anInt2862;
  public int[] v2;
  public int[] v0;
  public byte[] aByteArray2866;
  public byte[] aByteArray2867;
  public byte[] aByteArray2869;
  public short[] triangleColors;
  public VertexNormal[] vertexNormals;
  public short aShort2876;
  public byte[] aByteArray2877;
  public int[] v1;
  public short aShort2879;
  public int[] vy;
  public short[] aShortArray2882;
  public VertexNormal[] aClass50Array2883;
  public short[] aShortArray2884;
  public int[] vx;
  public FaceNormal[] faceNormals;
  public int amountVertices;
  public short[] aShortArray2888;
  public byte[] aByteArray2889;
  public int[][] boneGroups;
  public short[] aShortArray2891;
  public int[] vz;
  public short[] aShortArray2893;
  private short maximumY;
  private short minimumX;
  private boolean dimensionsUpdated;
  ...
  private Model(byte[] bytes) {
    if (bytes[bytes.length - 1] == -1 && bytes[bytes.length - 2] == -1) {
      this.parseRt4Config(bytes);
    } else {
      this.parseRt3Config(bytes);
    }
  }
    ...
    for (var11 = 0; var11 < var2; ++var11) {
      ...
      if (var13 != null) {
        ...
        for (var14 = 0; var14 < var13.amountFaces; ++var14) {
          ...
          this.v0[this.amountFaces] = this
              .method1995(var13, var13.v0[var14], var18);
          this.v1[this.amountFaces] = this
              .method1995(var13, var13.v1[var14], var18);
          this.v2[this.amountFaces] = this
              .method1995(var13, var13.v2[var14], var18);
          ++this.amountFaces;
        }

        for (var14 = 0; var14 < var13.anInt2862; ++var14) {
          assert this.aByteArray2857 != null;
  ...
  private void rotateZ(int angle) {
    int sine = Model.SINE_TABLE[angle];
    int cosine = Model.COSINE_TABLE[angle];
  ...
  public void method1866(SceneNode var1, int var2, int var3, int var4,
            ...
            if (var14 >= var6.minimumZ && var14 <= var6.maximumZ) {
              for (int var15 = 0; var15 < var9; ++var15) {
                ...
                if (var13 == var8[var15] && var14 == var6.vz[var15] && var12 == var6.vy[var15]
                  ...
                  var18.c += var11.c;
                  ++var7;
                  Model.anIntArray2861[var10] = Model.anInt2868;
                  Model.anIntArray2875[var15] = Model.anInt2868;
                }
              }
            }
          }
    ...
    if (var7 >= 3 && var5) {
      for (var10 = 0; var10 < this.amountFaces; ++var10) {
        if (Model.anIntArray2861[this.v0[var10]] == Model.anInt2868
          && Model.anIntArray2861[this.v1[var10]] == Model.anInt2868
          && Model.anIntArray2861[this.v2[var10]] == Model.anInt2868) {
      ...
      for (var10 = 0; var10 < var6.amountFaces; ++var10) {
        if (Model.anIntArray2875[var6.v0[var10]] == Model.anInt2868
          && Model.anIntArray2875[var6.v1[var10]] == Model.anInt2868
          && Model.anIntArray2875[var6.v2[var10]] == Model.anInt2868) {
  ...
  private int method1995(Model var1, int var2, short var3) {
  ...
  private void method1996(int[][] var1, int var2, int var3, int var4, int var5, int var6) {
    ...
    int var10 = -var5 / 2;
    int var11 = -var6 / 2;
    int var12 = Model.method2009(var1, var2 + var10, var4 + var11);
    int var13 = var5 / 2;
    int var14 = -var6 / 2;
    int var15 = Model.method2009(var1, var2 + var13, var4 + var14);
    int var16 = -var5 / 2;
    int var17 = var6 / 2;
    int var18 = Model.method2009(var1, var2 + var16, var4 + var17);
    int var19 = var5 / 2;
    int var20 = var6 / 2;
    int var21 = Model.method2009(var1, var2 + var19, var4 + var20);
  ...
  public void updateNormals() {
    if (this.vertexNormals == null) {
      ...
      for (face = 0; face < this.amountFaces; ++face) {
        ...
        int magnitude = (int) Math.sqrt(vx * vx + vy * vy + vz * vz);
        if (magnitude <= 0) {
          magnitude = 1;
        }
  ...
  public Model method1999(int var1, int var2, int[][] var3, int[][] var4,
      int var5,
      int var6,
      int var7,
      boolean var8,
  ...
  private void parseRt4Config(byte[] var1) {
  ...
  private void rotateX(int var1) {
    int var2 = Model.SINE_TABLE[var1];
    int var3 = Model.COSINE_TABLE[var1];
  ...
  public void initializeSkinAndBoneGroups() {
    int[] var1;
    int var2;
    int var3;
    int var4;
  ...
  public void rotate(int rotationX, int rotationY, int rotationZ ) {
    ...
    int var7;
    if (rotationZ != 0) {
      var4 = Model.SINE_TABLE[rotationZ];
      var5 = Model.COSINE_TABLE[rotationZ];
    ...
    if (rotationX != 0) {
      var4 = Model.SINE_TABLE[rotationX];
      var5 = Model.COSINE_TABLE[rotationX];
    ...
    if (rotationY != 0) {
      var4 = Model.SINE_TABLE[rotationY];
      var5 = Model.COSINE_TABLE[rotationY];
  ...
  private void parseRt3Config(byte[] bytes) {
    boolean var2 = false;
    boolean var3 = false;
  ...
  public static void destroy() {
    Model.anIntArray2861 = null;
    Model.anIntArray2875 = null;
    Model.SINE_TABLE = null;
    Model.COSINE_TABLE = null;
  }
