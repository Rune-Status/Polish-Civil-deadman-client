...
public final class DummyClass41 {
  ...
  public static void method1171(int var0, int var1, int var2, int var3, int var4, Widget var5,
    ...
    int var7 = var3 * var3 + var4 * var4;
      if ((var7 <= 360000)) {
        ...
        if (var8 * var8 >= var7) {
          DummyClass36.method1030(var5, GlobalStatics_9.aClass3_Sub28_Sub16Array2690[var0],
          ...
          if (GlRenderer.useOpenGlRenderer) {
            ((GlDirectColorSprite) GlobalStatics_9.aClass3_Sub28_Sub16Array3458[var0]).method648(
              240, 240, (var5.anInt168 / 2 + var2 + var16) * 16,
              16 * (-var17 + var5.anInt193 / 2 + var1), (int) (10430.378D * var14), 4096);
          } else {
            ((SoftwareDirectColorSprite) GlobalStatics_9.aClass3_Sub28_Sub16Array3458[var0]).method660(
  ...
  public static void method1173(Buffer var0, int var1) {
    int var2 = var0.readUnsignedShortSmart();
      ...
      GlobalStatics_10.anInt3054 = var0.readUnsignedShortSmart();
      GlobalStatics_8.anInt1416 = var0.readUnsignedShortSmart();
      GlobalStatics_9.anInt906 = var0.readUnsignedShortSmart();
      DummyClass26.aClass44_Sub1Array1609 =
        new GameWorld[-GlobalStatics_10.anInt3054 + GlobalStatics_8.anInt1416 + 1];

      for (var3 = 0; var3 < GlobalStatics_9.anInt906; ++var3) {
    ...
    int var2 = 49 % ((var1 - 22) / 46);
      return (GlobalStatics_8.method44(var0).method101(-69) != 0) ?
        (var0.aClass94_245 != null
          ...
          var0.aClass94_245 :
          (GlobalStatics_9.aBoolean1040 ? GlobalStatics_8.aClass94_2116 : null)) :
        null;
  }
