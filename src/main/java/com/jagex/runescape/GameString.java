...
public final class GameString implements UnusedInterface1 {
  ...
  public URL method1527(boolean var1) {
    ...
    } catch (RuntimeException | MalformedURLException var3) {
  ...
  public int method1530(byte var1, int var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var10, "na.AB(" + var1 + ',' +
          var2 + ')');
    }
  }
  ...
  public URL method1547(URL var1, boolean var2) {
    try {
      if (!var2) {
        this.bytes = null;
      }
    ...
    } catch (RuntimeException | MalformedURLException var4) {
      throw AbstractGameWorld.cascadeException(
          var4,
  ...
  public GameString method1548(boolean var1, int var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var4, "na.OA(" + var1 + ',' +
          var2 + ')');
    }
  }
  ...
  public void method1549(boolean var1) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var5, "na.BA(" + ')');
    }
  }
  ...
  public void method1553(int var1, boolean var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var5, "na.RA(" + var1 + ',' +
          var2 + ')');
    }
  }
  ...
  public GameString method1560(GameString var1, boolean var2,
    ...
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var9, "na.IA(" + (var1 != null ? "{...}" : "null") + ',' + var2 +
              ',' + (var3 != null ? "{...}" : "null") + ')');
    }
  }
  ...
  private boolean method1561(int var1, boolean var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var9, "na.P(" + var1 + ',' +
          var2 + ')');
    }
  }
    ...
    try {
      if (this.length < var2.length) {
        ...
        for (int var3 = 0; var2.length > var3; ++var3) {
          ...
          if (var5 >= 65 && var5 <= 90 ||
              -64 <= var5 && -34 >= var5 && -41 != var5) {
            var5 = (byte) (var5 + 32);
          }

          if (65 <= var4 && ~var4 >= -91 ||
              var4 >= -64 && -34 >= var4 && var4 != -41) {
            var4 = (byte) (var4 + 32);
          }
  ...
  public GameString method1564(int var1) {
    try {
      ...
      for (var2 = 0; var2 < this.length &&
          (0 <= this.bytes[var2] && 32 >= this.bytes[var2] ||
              -161 == ~(255 & this.bytes[var2]));
          ++var2) {
      }
      ...
      for (var3 = this.length;
          var3 > var2 &&
              (~this.bytes[var3 - 1] <= -1 && -33 <= ~this.bytes[var3 - 1] ||
                  -161 == ~(255 & this.bytes[var3 + -1]));
          --var3) {
      }
  ...
  public int indexOf(GameString var1, int start, int var3) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var12, "na.CB(" + (var1 != null ? "{...}" : "null") + ',' + start +
              ',' + var3 + ')');
    }
  }
  ...
  public GameString method1572(int var1, byte var2) {
    try {
      ...
      throw AbstractGameWorld.cascadeException(var5, "na.L(" + var1 + ',' +
          var2 + ')');
    }
  }
  ...
  public GameString method1579(int var1) {
    try {
      ...
      return var1 >= -4 ? null
          : (null == var2 ? DummyClass21.aClass94_1760 : var2);
    } catch (RuntimeException var3) {
  ...
  public int method1580(boolean var1, byte[] var2, int var3, int var4,
    ...
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var7, "na.LA(" + var1 + ',' + (var2 != null ? "{...}" : "null") +
              ',' + var3 + ',' + var4 + ',' + var5 + ')');
    }
  }
  ...
  public static boolean method1529(int var0, int var1, int var2, int var3,
    ...
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var17, "na.N(" + var0 + ',' + var1 + ',' + var2 + ',' + var3 + ',' +
              var4 + ',' + var5 + ',' + var6 + ',' + var7 + ')');
    }
  }
  ...
  public static SoftwareDirectColorSprite method1537(FileUnpacker var0,
    ...
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var4, "na.GB(" + (var0 != null ? "{...}" : "null") + ',' + var1 +
              ',' + var2 + ')');
    }
  }
  ...
  public static AbstractDirectColorSprite method1570(int var0, byte var1,
    ...
    try {
      ...
      throw AbstractGameWorld.cascadeException(
          var20, "na.WA(" + var0 + ',' + var1 + ',' + var2 + ',' + var3 + ',' +
              var4 + ',' + var5 + ',' + var6 + ',' + var7 + ')');
    }
  }
}
