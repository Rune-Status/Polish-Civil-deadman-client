...
public final class GameClient extends GameStub {
  ...
  private void updateGame(byte var1) {
    for (
      ...
      if (!GlRenderer.useOpenGlRenderer) {
      ...
      } else if (GlobalStatics_10.loginState == 0 && DummyCanvas.anInt23 == 0) {
        ...
        if (GlobalStatics_9.anInt3995 >> 7 < 14 || GlobalStatics_9.anInt3995 >> 7 >= 90
      ...
      if ((GlobalStatics_10.anInt3068 > 0)) {
        ...
        try {
          ...
          if (DummyClass18.anInt80 == 2) {
            ...
            ++DummyClass18.anInt80;
            GlobalStatics_9.lastWrittenTime = GlobalStatics_10.getCurrentTimeMillis();
          }
      ...
      if (GlobalStatics_9.loadingState == 0) {
        ...
        if ((GlobalStatics_9.loadingState == 10)) {
          ...
          if (GlobalStatics_5.fileSystem.isUpdateTableReceived()) {
            ...
            GlobalStatics_10.textures = FileSystem
          ...
          if ((GlobalStatics_9.loadingState == 45)) {
            GlobalStatics_8.method1959(256, 2, 22050, TextureSampler17.aBoolean3184);
            ...
            if (GlobalStatics_9.loadingState == 60) {
              var2 = GlobalStatics_9.method599(-20916, Projectile.sprites);
              ...
              if ((GlobalStatics_9.loadingState == 65)) {
                ...
                if (GlobalStatics_9.loadingState == 70) {
                  ...
                  if ((var2 >= 1100)) {
                    ...
                    GlobalStatics_6.method575(Something3dRoot.configs, -1);
                    ...
                    GlobalStatics_9.method1864(true, (byte) -126,
                        ...
                        DummyClass13.models);
                    GlobalStatics_9.method969(Something3dRoot.configs, 59);
                    GlobalStatics_10.setAnimationFileUnpackers(
                        GlobalStatics_9.animationBases,
                        GlobalStatics_10.animationSequences, -77,
                        GlobalStatics_9.animationFrames);
                    GlobalStatics_7.method1053((byte) -117, Something3dRoot.configs);
                    ...
                    GlobalStatics_0.method89(true, GlobalStatics_8.fileUnpacker13,
                        Projectile.sprites,
                        GlobalStatics_8.widgets, DummyClass13.models);
                    GlobalStatics_10.method250(2048, Something3dRoot.configs);
                    DummyClass39.method1086(GlobalStatics_9.fileUnpacker17, -6);
                    GlobalStatics_9
                        .method205(GlobalStatics_9.fileUnpacker25, 115,
                            GlobalStatics_9.fileUnpacker24, new EnumStringFetcher());
                  ...
                  if (GlobalStatics_9.loadingState == 80) {
                      ...
                      if ((GlobalStatics_9.loadingState != 120)) {
                        if ((GlobalStatics_9.loadingState == 130)) {
                                    ...
                                    GlobalStatics_9.concat(new GameString[]{
                                        ...
                                        GlobalStatics_9.toString(
                                            85 + (GlobalStatics_8.fileUnpacker13
                                                .method2136((byte) -124)
                                                / 20)), GlobalStatics_9.aClass94_468
                                    });
                                GlobalStatics_6.loadingPercent = 85;
                              }
                            } else {
                          ...
                          GlobalStatics_6.anInt2529 =
                              GlobalStatics_8.widgets.getFileId(GlobalStatics_9.aClass94_3992);
                    ...
                    GlobalStatics_3.loadingText = GlobalStatics_9
                        .concat(new GameString[]{
                            GlobalStatics_10.aClass94_1892, GlobalStatics_9.toString(
                            GlobalStatics_10.materials
                                .method2136((byte) -125)),
                            GlobalStatics_9.aClass94_468
                        });
            ...
            var2 =
                GlobalStatics_10
                    .method228(Projectile.sprites, GlobalStatics_8.fileUnpacker13,
                        false);
          ...
          if (var2 == 100) {
            ...
            GlobalStatics_10.method1593(111, Projectile.sprites);
            GlobalStatics_10.setRunesFileId(Projectile.sprites);
  ...
  public void destroy(byte var1) {
    if (GlRenderer.useOpenGlRenderer) {
      ...
      GlobalStatics_9.unbind(GlobalStatics_8.INSTANCE);
      if (DummyClass35.mouseWheel != null) {
    ...
    if ((DummyClass15.state != 1000)) {
        ...
        if (((DummyClass15.state == 30) || (DummyClass15.state == 10)) && (
            GlobalStatics_6.replaceCanvas || (DummyClass41.aLong866 != 0L)
                && DummyClass41.aLong866 < GlobalStatics_10.getCurrentTimeMillis())) {
        ...
        if (GlobalStatics_10.fullScreenFrame == null) {
          ...
          if (var4 != GlobalStatics_6.windowWidth
            ...
            DummyClass41.aLong866 = GlobalStatics_10.getCurrentTimeMillis() + 500L;
          }
        }
        ...
        if ((DummyClass15.state == 0)) {
          ...
          if (DummyClass15.state != 25 && (DummyClass15.state != 28)) {
            if (DummyClass15.state == 30) {
              ...
              GlobalStatics_3
                  .drawLoadingBox(GlobalStatics_9.concat(new GameString[]{
                      GlobalStatics_9.CONNECTION_LOST, GlobalStatics_0.LINE_BREAK,
            ...
            if ((GlobalStatics_0.anInt2579 < GlobalStatics_8.anInt3293)) {
              GlobalStatics_0.anInt2579 = GlobalStatics_8.anInt3293;
            }

            var4 = 50 * (GlobalStatics_0.anInt2579 - GlobalStatics_8.anInt3293)
        ...
        if (GlRenderer.useOpenGlRenderer && (DummyClass15.state != 0)) {
          ...
          if (((DummyClass15.state == 30) || DummyClass15.state == 10)
            ...
            try {
              graphics = GlobalStatics_8.INSTANCE.getGraphics();
  ...
  public void initialize(int var1) {
    DummyClass25.resizeCanvas();
      ...
      GlobalStatics_10.method193((byte) 115, GlobalStatics_8.INSTANCE);
      GlobalStatics_9.bindMouseListener(GlobalStatics_8.INSTANCE);
      DummyClass35.mouseWheel = DummyClass60.createMouseWheel((byte) 15);
      if (DummyClass35.mouseWheel != null) {
        DummyClass35.mouseWheel.bind(GlobalStatics_8.INSTANCE, -97);
      }
