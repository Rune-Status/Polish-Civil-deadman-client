...
public final class SomethingFont {
  ...
  private static String aString597 =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
      ...
      + '\u00f9' + '\u00c2' + '\u00ca' + '\u00ce' + '\u00d4' + '\u00db' + '\u00e2' + '\u00ea'
      + '\u00ee' + '\u00f4' + '\u00fb' + '\u00c6' + '\u00e6';
  private static final int anInt598 = SomethingFont.aString597.length();
  private static int[] anIntArray599 = new int[256];

  static {
    for (int var0 = 0; var0 < 256; ++var0) {
      int var1 = SomethingFont.aString597.indexOf(var0);
      if (var1 == -1) {
        var1 = 74;
      }

      SomethingFont.anIntArray599[var0] = var1 * 9;
    }
  ...
  public SomethingFont(int var1, boolean bold, Component var3 ) {
    this.anInt596 = SomethingFont.anInt598 * 9;
    this.aBoolean595 = false;
    Font var4 = new Font("Helvetica", bold ? 1 : 0, var1);
    FontMetrics var5 = var3.getFontMetrics(var4);

    int var6;
    for (var6 = 0; var6 < SomethingFont.anInt598; ++var6) {
      this.method1004(var4, var5, SomethingFont.aString597.charAt(var6), var6, false);
    }
    ...
    if (bold && this.aBoolean595) {
      ...
      if (!this.aBoolean595) {
        ...
        for (var6 = 0; var6 < SomethingFont.anInt598; ++var6) {
          this.method1004(var4, var5, SomethingFont.aString597.charAt(var6), var6, true);
        }
      }
    }
  ...
  private void method997(GameString var1, int var2, int var3, int var4, boolean var5) {
    ...
    for (int var6 = 0; var6 < var1.getLength(); ++var6) {
      int var7 = SomethingFont.anIntArray599[var1.charAt(var6)];
      if (var5) {
  ...
  private void method1004(Font var1, FontMetrics var2, char var3, int var4, boolean var5) {
    ...
    Image var11 = GameCanvas.INSTANCE.createImage(var6, var9);
  ...
  private int method1005(GameString var1) {
    ...
    for (int var3 = 0; var3 < var1.getLength(); ++var3) {
      if (var1.charAt(var3) == 64 && var3 + 4 < var1.getLength() && var1.charAt(var3 + 4) == 64) {
        ...
        var2 += this.aByteArray594[SomethingFont.anIntArray599[var1.charAt(var3)] + 7];
      }
    }
  ...
  public static void method999() {
    SomethingFont.aString597 = null;
    SomethingFont.anIntArray599 = null;
  }
}
