...
public class GlobalStatics_3 {
      ...
      if (var2 != -40) {
        ...
        for (int var5 = 0; GlobalStatics_9.widgetQuads > var5; ++var5) {
          if ((GlTexture2d.quadx1[var5] + GlobalStatics_5.quadx0[var5]) > var0
            ...
            GlobalStatics_9.quady1[var5] + GlobalStatics_9.quady0[var5])) && GlobalStatics_9.quady0[var5] < var3 + var4) {
    ...
    public static SoftwareFont method163(byte[] var0, int var1) {
      if (var0 == null) {
          ...
          SoftwareFont var2 =
            new SoftwareFont(var0, GlobalStatics_9.anIntArray2048, GlobalStatics_0.anIntArray2591,
    ...
    public static void drawLoadingBox(GameString text, boolean draw) {
      byte var3 = 4;
        ...
        GlobalStatics_9.p12Font.draw(text, var4, var5, var6, var7, 16777215, -1, 1, 1, 0);
        ...
        if (draw) {
          if (GlRenderer.useOpenGlRenderer) {
            ...
            try {
              Graphics graphics = GlobalStatics_8.INSTANCE.getGraphics();
    ...
    public static void method2061(boolean var0) {
      GlobalStatics_9.anInt2556 = 0;
        ...
        for (SomethingPacket151 var7 =
             ...
             var7 != null;
             var7 = (SomethingPacket151) GlobalStatics_10.aClass130_3208.getNext(-104)) {
