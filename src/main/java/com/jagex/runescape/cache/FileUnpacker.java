...
public final class FileUnpacker {
  ...
  public int getFileId(GameString var1) {
    if (this.method2122()) {
      ...
      return this.method2130(var3) ? var3 : -1;
    } else {
      return -1;
    }
  }
  ...
  public byte[] unpack(int fileId, int[] var2, int var3, int childId) {
    if (this.method2139(fileId, 0, childId)) {
      if (this.buffers[fileId] == null
        ...
        boolean var5 = this.method2132(fileId, var2);
        if (!var5) {
          this.method2134(false, fileId);
          var5 = this.method2132(fileId, var2);
          if (!var5) {
            return null;
          }
        }
  ...
  private void method2131(int var1, int var2) {
    ...
    if (var1 < 101) {
      this.method2132(53, null);
    }
  }

  private boolean method2132(int var1, int[] var3) {
    if (!this.method2130(var1)) {
      return false;
      ...
      if (var7) {
        ...
        if (var3 != null && (var3[0] != 0 || var3[1] != 0 || var3[2] != 0
            || var3[3] != 0)) {
          var21 = CacheStatics
              .method1985(-124, this.anObjectArray1954[var1], true);
          Buffer var22 = new Buffer(var21);
          var22.method770(var3, 120, 5, var22.bytes.length);
        } else {
          var21 = CacheStatics
              .method1985(-128, this.anObjectArray1954[var1], false);
        }

        byte[] var23;
        try {
          var23 = CacheStatics.method623((byte) -125, var21);
        } catch (RuntimeException var19) {
          assert var21 != null;
          throw new IllegalStateException(
              "T3 - " + (var3 != null) + "," + var1 + "," + var21.length + ","
                  + CacheStatics.getChecksum(var21, var21.length, false) + ","
                  + CacheStatics.getChecksum(var21, var21.length - 2, false)
                  + ","
        ...
        if (var4 > 1) {
          ...
          for (var16 = 0; var4 > var16; ++var16) {
            ...
            if (this.aBoolean1946) {
              ...
              var6[var17] = CacheStatics
                  .method890(false, -114, var24[var16]);
            }
          }
        } else {
          if (var5 != null) {
          ...
          if (this.aBoolean1946) {
            ...
            var6[var10] = CacheStatics.method890(false, -80, var23);
          }
        }
  ...
  private void method2134(boolean var1, int var2) {
    if (this.aBoolean1945) {
      ...
      this.anObjectArray1954[var2] =
          CacheStatics.method890(false, -101, this.aClass151_1947
              .method2098(var2, 0));
    }
  ...
  public byte[] getBytes(int var1, int var2, int var3) {
    if (this.method2139(var2, var3 + var3, var1)) {
      if (this.buffers[var2] == null || this.buffers[var2][var1] == null) {
        boolean var4 = this.method2132(var2, null);
        if (!var4) {
          this.method2134(false, var2);
          var4 = this.method2132(var2, null);
          if (!var4) {
            return null;
          }
        }
      ...
      byte[] var6 = CacheStatics
          .method1985(-126, this.buffers[var2][var1], false);
      return var6;
    } else {
      return null;
    }
  ...
  public int[] getChildIds(int var2) {
    if (this.method2130(var2)) {
  ...
  public boolean isLoaded(int fileId) {
    ...
    } else if (this.method2130(fileId)) {
      if (this.table.unpackedLengths[fileId] == 1) {
