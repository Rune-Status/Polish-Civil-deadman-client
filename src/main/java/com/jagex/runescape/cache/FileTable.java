...
import com.jagex.runescape.common.Djb2;
import com.jagex.runescape.common.LinearHashTable;
...
public final class FileTable {
  ...
  public FileTable(byte[] var1, int var2) {
    this.checksum = CacheStatics.getChecksum(var1, var1.length, false);
  ...
  private void parse(byte[] var2) {
    Buffer var3 = new Buffer(CacheStatics.method623((byte) -114, var2));
    ...
    if (var4 != 5 && var4 != 6) {
      ...
      for (var8 = 0; var8 < this.anInt947; ++var8) {
        ...
        for (var12 = 0; var10 > var12; ++var12) {
          int id = this.unpackedIds[entryId][var12] = var6 += var3
              .readUnsignedShort();
          if (id > maximumId) {
            maximumId = id;
          }
      ...
      if (var5 != 0) {
        ...
        for (var8 = 0; var8 < this.anInt947; ++var8) {
          ...
          for (maximumId = 0; maximumId < this.unpackedLengths[entryId];
              ++maximumId) {
