...
public final class AudioStreamEncoder3 extends AudioStreamEncoder {
  ...
  public AudioStreamEncoder method411() {
    AudioSomethingSomething var1 = (AudioSomethingSomething) this.aClass61_3489
        .getFirst();
    return var1 != null ?
        var1.aClass3_Sub24_Sub1_2507 != null ? var1.aClass3_Sub24_Sub1_2507
            : this
                .method414() :
        null;
  }
  ...
  public void method413(int[] var1, int var2, int var3) {
    ...
    for (
        AudioSomethingSomething var6 = (AudioSomethingSomething) this.aClass61_3489
            .getFirst();
        var6 != null;
        var6 = (AudioSomethingSomething) this.aClass61_3489.getNext()) {
  ...
  public void method415(int var1) {
    ...
    for (
        AudioSomethingSomething var3 = (AudioSomethingSomething) this.aClass61_3489
            .getFirst();
        var3 != null;
        var3 = (AudioSomethingSomething) this.aClass61_3489.getNext()) {
  ...
  private void method469(int[] var1, AudioSomethingSomething var2, int var3,
      int var4,
      int var5, byte var6) {
