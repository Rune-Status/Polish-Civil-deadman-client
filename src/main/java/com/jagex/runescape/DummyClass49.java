...
public final class DummyClass49 {
  ...
  public static SoftwareIndexedColorSprite method1364(byte var0) {
    SoftwareIndexedColorSprite var1 =
        new SoftwareIndexedColorSprite(GlobalStatics_9.anInt2426, GlobalStatics_9.anInt1748,
  ...
  public static void method1367(int var0, int var1, int var2, byte var3, int var4, int var5) {
    GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var2++], var5, 92, var1, var0);
      GlobalStatics_10.method282(DummyClass35.anIntArrayArray663[var4--], var5, 97, var1, var0);
      if (var3 >= 23) {
