...
public final class DummyClass9 extends DummyClass5 {
  ...
  public static void method2214(int var0) {
    if (var0 != 0) {
      ...
      if (!GlobalStatics_9.method1986(90) && (GlobalStatics_8.plane != GlobalStatics_9.currentPlane)) {
        GlobalStatics_7.rebuildScene(GlobalStatics_9.currentPlane, GlobalStatics_10.anInt2294,
          GlobalStatics_2.anInt3606, GlobalStatics_9.localPlayer.waypointsY[0], false,
          GlobalStatics_9.localPlayer.waypointsX[0], true);
      } else {
        if ((GlobalStatics_9.currentPlane != DummyClass43.anInt909) && GlobalStatics_6.method385(
      ...
      if ((GlobalStatics_9.anInt3375 != 0)) {
        try {
          ...
          if ((GlobalStatics_9.anInt3375 == 3)) {
            ...
            var1 = GlobalStatics_9.gameSocket.read() << 8 | GlobalStatics_9.gameSocket.read();
