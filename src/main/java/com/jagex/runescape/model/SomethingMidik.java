...
public final class SomethingMidik {
  ...
  private final int anInt1939 = GlobalStatics_11.method368(16);
  ...
  public SomethingMidik() {
    this.anInt1938 = GlobalStatics_11.method368(24);
    this.anInt1940 = GlobalStatics_11.method368(24);
    this.anInt1941 = GlobalStatics_11.method368(24) + 1;
    this.anInt1943 = GlobalStatics_11.method368(6) + 1;
    this.anInt1937 = GlobalStatics_11.method368(8);
    int[] is = new int[this.anInt1943];
    for (int i = 0; i < this.anInt1943; i++) {
      int i_0_ = 0;
      int i_1_ = GlobalStatics_11.method368(3);
      boolean bool = GlobalStatics_11.method364() != 0;
      if (bool) {
        i_0_ = GlobalStatics_11.method368(5);
      }
      is[i] = i_0_ << 3 | i_1_;
    }
  ...
  public void method2112(float[] fs, int i, boolean bool ) {
    ...
    if (!bool) {
      ...
      for (int i_6_ = 0; i_6_ < 8; i_6_++) {
        ...
        while (i_7_ < i_5_) {
          if (i_6_ == 0) {
            int i_8_ = GlobalStatics_11.aClass71Array2406[this.anInt1937].method1290();
