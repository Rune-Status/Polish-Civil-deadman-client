...
public final class SomethingMidiInstrument {
  ...
  public SomethingMidiInstrument() {
    GlobalStatics_11.method368(24);
    this.anInt1063 = GlobalStatics_11.method368(16);
    this.anInt1065 = GlobalStatics_11.method368(24);
    this.anIntArray1061 = new int[this.anInt1065];
    boolean var1 = GlobalStatics_11.method364() != 0;
    int var2;
    int var3;
    int var5;
    if (var1) {
      ...
      for (var3 = GlobalStatics_11.method368(5) + 1; var2 < this.anInt1065; ++var3) {
        int var4 =
          GlobalStatics_11.method368(GlobalStatics_9.method513(
      ...
      boolean var14 = GlobalStatics_11.method364() != 0;

      for (var3 = 0; var3 < this.anInt1065; ++var3) {
        if (var14 && GlobalStatics_11.method364() == 0) {
          this.anIntArray1061[var3] = 0;
        } else {
          this.anIntArray1061[var3] = GlobalStatics_11.method368(5) + 1;
        }
      }
    }

    this.method1289();
    var2 = GlobalStatics_11.method368(4);
    if (var2 > 0) {
      float var16 = GlobalStatics_11.method358(GlobalStatics_11.method368(32));
      float var15 = GlobalStatics_11.method358(GlobalStatics_11.method368(32));
      var5 = GlobalStatics_11.method368(4) + 1;
      boolean var6 = GlobalStatics_11.method364() != 0;
      int var7;
      if (var2 == 1) {
        var7 = GlobalStatics_4.method1291(this.anInt1065,
            this.anInt1063);
      } else {
      ...
      for (var8 = 0; var8 < var7; ++var8) {
        this.anIntArray1064[var8] = GlobalStatics_11.method368(var5);
      }
  ...
  public int method1290() {
    ...
    for (
      ...
      var1 = GlobalStatics_11.method364() != 0 ? this.anIntArray1066[var1] : var1 + 1) {
    }
