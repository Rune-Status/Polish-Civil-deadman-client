...
public final class PlayerAppearance {
  ...
  public AbstractModel method1157(int var1, int var2, int var3, int var4,
    ...
    AbstractModel var11 = (AbstractModel) GlobalStatics_9.aClass93_1131
        .get(var9);
    if (var11 == null) {
      Model[] var12 = new Model[3];
      int var13 = 0;
      if (!GlobalStatics_10.getIdentityKit(var3, 0)
          .method948(var8 ^ -2012744886)
      ...
      for (int var15 = 0; var15 < 5; ++var15) {
        if (this.anIntArray862[var15]
            < GlobalStatics_2.aShortArrayArray344[var15].length) {
        ...
        if (DummyClass55.aShortArrayArray1429[var15].length
            > this.anIntArray862[var15]) {
  ...
  private void method1158(int var1) {
    ...
    for (var5 = 0; var5 < 5; ++var5) {
      ...
      this.aLong860 =
          var4[(int) ((this.anIntArray862[var5] ^ this.aLong860) & 255L)]
              ^ this.aLong860 >>> 8;
    }
  ...
  public AbstractModel method1165(Unsure[] var1, int var2,
    ...
    if (this.npcId == -1) {
      ...
      AbstractModel var37 = (AbstractModel) GlobalStatics_9.aClass93_1911
          .get(var13);
      boolean var17;
      int var23;
      int var22;
      ...
      if (var37 == null) {
        ...
        if (var17) {
          if (this.aLong855 != -1L) {
            var37 = (AbstractModel) GlobalStatics_9.aClass93_1911
                .get(this.aLong855);
          }
  ...
  public AbstractModel method1167(int var1, byte var2,
    ...
    if (this.npcId == -1) {
      ...
      if (var6 == null) {
        ...
        for (int var8 = 0; var8 < 12; ++var8) {
          ...
          if ((1073741824 & var9) == 0) {
            if ((var9 & Integer.MIN_VALUE) != 0 && !GlobalStatics_10
                .getIdentityKit(
        ...
        for (int var10 = 0; var10 < 12; ++var10) {
          ...
          if ((1073741824 & var11) == 0) {
            if ((Integer.MIN_VALUE & var11) != 0) {
              var12 = GlobalStatics_10.getIdentityKit(1073741823 & var11, 0)
                  .method941(true);
              if (var12 != null) {
                var14[var9++] = var12;
              }
        ...
        for (var11 = 0; var11 < 5; ++var11) {
          if (GlobalStatics_2.aShortArrayArray344[var11].length
              > this.anIntArray862[var11]) {
          ...
          if (DummyClass55.aShortArrayArray1429[var11].length
              > this.anIntArray862[var11]) {
      ...
      return GlobalStatics_2
          .getNpcConfiguration(this.npcId)
          .method1482(var3, var1, var5, -109, var4);
    }
  }
