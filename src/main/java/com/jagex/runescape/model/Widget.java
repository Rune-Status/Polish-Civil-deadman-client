...
public final class Widget {
  ...
  public boolean method855(int var1) {
    if (this.anIntArray207 != null) {
      ...
      SoftwareIndexedColorSprite var2 =
          GlobalStatics_0.createSprite(0, true, this.anInt224,
              GlobalStatics_9.aClass153_323);
      if (var2 == null) {
        return false;
      } else {
        var2.method1675();
        ...
        if (var8 == 1) {
          var10 =
              (AbstractModel) GlobalStatics_9.aClass93_2428.get(
                  65536 + var9);
          if (var10 == null) {
            Model var18 = GlobalStatics_10
                .getModel(DummyClass25.aClass153_1628, var9, 0);
            if (var18 == null) {
              GlobalStatics_8.aBoolean6 = true;
              return null;
            }
          ...
          if (var8 != 3) {
            if (var8 == 4) {
              ...
              AbstractModel var17 = var16
                  .getModel(110, var1, var5, var2, 10, var3);
              if (var17 != null) {
                return var17;
              } else {
                GlobalStatics_8.aBoolean6 = true;
              ...
              if (var8 != 7) {
                ...
                AbstractModel var13 =
                    var7.method1157(var1, var12, var15, var5, var2, var3, var11,
                        -2012759707);
                if (var13 == null) {
                  GlobalStatics_8.aBoolean6 = true;
                  return null;
              ...
              var10 = GlobalStatics_2.getNpcConfiguration(var9)
                  .method1476(null, 0, (byte) -120, 0, var1, var5, var3, null,
                      0, var2);
              if (var10 != null) {
                return var10;
              } else {
  ...
  public AbstractDirectColorSprite method866(byte var1, boolean var2) {
    ...
    if (var3 == -1) {
      ...
      long var4 =
          ((this.aBoolean178 ? 1L : 0L) << 38) + ((this.aBoolean157 ? 1L : 0L)
              << 35) + var3
              + ((long) this.anInt288 << 36) + ((this.aBoolean199 ? 1L : 0L)
              << 39) + (
      ...
      if (var6 != null) {
        ...
        if (this.aBoolean157) {
          ...
          var7 = DummyClass59
              .method1043(0, GlobalStatics_9.aClass153_323, -3178, var3);
        }
  ...
  public void method867(int var1, Buffer var2) {
    ...
    if (var4 != 0) {
      ...
      for (this.aByteArray231 = new byte[10]; var4 != 0;
          var4 = var2.readUnsignedByte()) {
        var5 = (var4 >> 4) - 1;
  ...
  public AbstractFont method868(AbstractIndexedColorSprite[] var1,
    ...
    if (this.anInt270 == -1) {
      ...
      AbstractFont var3 = (AbstractFont) GlobalStatics_6.aClass93_743
          .get(this.anInt270);
      if (var3 != null) {
        return var3;
      } else {
