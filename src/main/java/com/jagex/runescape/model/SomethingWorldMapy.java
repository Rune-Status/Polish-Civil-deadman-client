...
public final class SomethingWorldMapy extends SubNode {
  ...
  public SomethingWorldMapy(GameString var1, GameString var2, int var3,
      int var4,
      int var5,
      boolean var6,
      int var7) {
  ...
  public boolean method537(int var1, byte var2, int var3) {
    if (this.anInt3555 <= var3 && var3 <= this.anInt3559
      ...
      for (SomethingWorldMappy var4 = (SomethingWorldMappy) this.aClass61_3560
          .getFirst();
          var4 != null;
          var4 = (SomethingWorldMappy) this.aClass61_3560.getNext()) {
  ...
  public void method538() {
    ...
    for (SomethingWorldMappy var2 = (SomethingWorldMappy) this.aClass61_3560
        .getFirst();
        var2 != null;
        var2 = (SomethingWorldMappy) this.aClass61_3560.getNext()) {
