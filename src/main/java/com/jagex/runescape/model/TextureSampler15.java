      ...
      if (this.anInt3193 > 0) {
        for (int var3 = 0; var3 < 512; ++var3) {
          this.aShortArray3200[var3] =
              (short) GlobalStatics_8
                  .method1603((byte) 23, this.anInt3193, var2);
        }
      }
    ...
    if (this.monoChromaticImageCache.aBoolean1580) {
      ...
      for (int var15 = 0; var15 < GlobalStatics_9.anInt1559; ++var15) {
        ...
        for (int var9 = var6 - 1; var9 <= var7; ++var9) {
          int var13 =
              255 & this.aByteArray3195[
                  (this.anInt3204 <= var9 ? -this.anInt3204 + var9 : var9)
                      & 255];

          for (int var8 = var17 - 1; var18 >= var8; ++var8) {
            int var14 = (255 & this.aByteArray3195[
                (this.anInt3203 <= var8 ? -this.anInt3203 + var8 : var8) + var13
                    & 255]) * 2;
