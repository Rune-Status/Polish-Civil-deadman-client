...
public final class GameObjectConfig {
  ...
  public GameObjectConfig method1685(int var1) {
    if (var1 != 0) {
      this.method1697(-92, 83, null, -13, null, 18, null, true, 114, 123, null,
          118, 85, -116);
    }
  ...
  private Model method1686(int var1, int var2, int var3) {
    ...
    var11 = !(this.anInt1479 == 128
        && this.anInt1488 == 128 && this.anInt1481 == 128);
      ...
      for (var9 = 0; this.aShortArray1477.length > var9; ++var9) {
        if (this.aByteArray1513 != null && this.aByteArray1513.length > var9) {
          var13.replaceColor(this.aShortArray1477[var9],
              GlobalStatics_10.aShortArray3110[255
                  & this.aByteArray1513[var9]]);
        } else {
          var13.replaceColor(this.aShortArray1477[var9],
              this.aShortArray1506[var9]);
        }
      }
    }
  ...
  public boolean method1690(int var1) {
    if (this.anIntArray1524 != null) {
      if (var1 != 28933) {
        this.method1696(34, 54, null, 55, 80, null, true, null, (byte) 127,
            true, -38);
      }
  ...
  public void method1692(int var1, Buffer var2) {
    while (true) {
      ...
      if (var3 == 0) {
        if (var1 != 6219) {
          this.method1696(105, -55, null, -39, 71, null, true, null,
              (byte) -117, false, -25);
        }
  ...
  private GlModel method1695(int var1, boolean var2, boolean var3, int var4) {
    ...
    boolean var18 =
        var1 == 0 && this.anInt1479 == 128
            && this.anInt1481 == 128 && this.anInt1496 == 0
            && this.anInt1534 == 0 && !var14;
    GlModel var19 = var5.createCopy(var18, var15,
        this.aShortArray1477 == null, true,
        var5.method1903() == var6, var1 == 0 && !var14, var3,
        var7 == var5.method1924(), true,
    ...
    if (this.aShortArray1477 != null) {
      for (var12 = 0; this.aShortArray1477.length > var12; ++var12) {
        var19.method1918(this.aShortArray1477[var12],
            this.aShortArray1506[var12]);
      }
    }

    if (this.aShortArray1476 != null) {
      for (var12 = 0; this.aShortArray1476.length > var12; ++var12) {
        var19.method1916(this.aShortArray1476[var12],
            this.aShortArray1495[var12]);
      }
    }

    if (this.anInt1479 != 128 || this.anInt1488 != 128
        || this.anInt1481 != 128) {
  ...
  public SceneShadowMap method1697(int var1, int var2,
    ...
    if (GlRenderer.USE_OPENGL) {
      ...
      if (this.aByte1505 != 0) {
        ...
        var22.method1919(this.aByte1505, this.aShort1500, var23, var7, var11,
            var2, var4, var1);
      }
      ...
      SoftwareModel var17 = (SoftwareModel) DummyClass14.aClass93_1965
          .get(var15);
      if (var17 == null) {
        ...
        var17 =
            new SoftwareModel(var18, 64 + this.anInt1494,
                this.anInt1489 * 5 + 768, -50, -10, -50);
      ...
      if (var5 != null) {
        var21 = true;
        var17 = (SoftwareModel) var5
            .method2054(19749, var9, var12, var17, var6, var14);
      }
      ...
      if (this.aByte1505 != 0) {
        ...
        var17 =
            var17.method1941(this.aByte1505, this.aShort1500, var7, var11, var2,
                var4, var1, false);
      }
