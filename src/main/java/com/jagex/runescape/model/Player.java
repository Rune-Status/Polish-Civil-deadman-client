...
public final class Player extends Mobile {
  ...
  public void parseConfig(Buffer buffer) {
    ...
    this.sceneX += (-var7 + this.getSize()) * 64;
    this.sceneY += 64 * (this.getSize() - var7);
    ...
    for (var11 = 0; var11 < 5; ++var11) {
      var12 = buffer.readUnsignedByte();
      if (var12 < 0
          || var12 >= GlobalStatics_2.aShortArrayArray344[var11].length) {
        var12 = 0;
      }
    ...
    this.name = Objects
        .requireNonNull(GameStringStatics.stringFromBase37(-29664, var20))
        .formatName((byte) -50);
    ...
    if (var14 != var8) {
      this.sceneX = 128 * this.waypointsX[0] + this.getSize() * 64;
      this.sceneY = 128 * this.waypointsY[0] + 64 * this.getSize();
    }
  }

  private void draw(DummyClass0 var1, int var2, AbstractModel var3, int var4,
      int var5,
    ...
    if (var16 >= 16 && var16 <= 360000) {
      ...
      AbstractModel var18 =
          GlobalStatics_10.method1763(true, var17, this.sceneY, var13,
              this.sceneX, var3,
              this.anInt2831);
      if (var18 != null) {
        if (GlRenderer.USE_OPENGL) {
          ...
          var18.draw(0, var12, var14, var11, var10, var5, var15, var9, -1L,
              var6);
    ...
    if (GlobalStatics_8.titlePrefixes != null) {
      name =
          GlobalStatics_9.concat(
              new GameString[]{GlobalStatics_8.titlePrefixes[this.titleId],
                  name});
    }
  ...
  public void draw(int var1, int var2, int var3, int var4, int var5, int var6,
    ...
    if (this.appearance != null) {
      ...
      if (GlobalStatics_10.usageMode != 0 && var16 < GlobalStatics_6.NEAR) {
        for (var17 = 50 - var16; DummyClass42.anInt893 < var17;
      ...
      if (var15 != null) {
        ...
        if (SettingsStatics.aBoolean2910 && (this.appearance.npcId == -1
          ...
          var23 = GlobalStatics_8.method1957(160,
              ...
              this.sceneX, 0, this.sceneY, 0, 1, var15, var1,
          ...
          for (var17 = GlobalStatics_8.aClass96Array2114.length - 1;
            ...
            if (var27 != null && var27.anInt1355 != -1) {
              ...
              if (var27.anInt1360 == 1 && var27.anInt1359 >= 0
                ...
                if (var24 != null) {
                  var20 = var24.sceneX
                      / 32 - GlobalStatics_9.localPlayer.sceneX / 32;
                  var21 = -(GlobalStatics_9.localPlayer.sceneY
                      / 32) + var24.sceneY / 32;
                  this.draw(null, var21, var15, var20, var6, var11, 2047, var1,
                      var8, var5, var4,
              ...
              if (var27.anInt1360 == 2) {
                int var29 =
                    4 * (-GlobalStatics_10.REGION_BASE_X + var27.anInt1356) + 2
                        -
                        GlobalStatics_9.localPlayer.sceneX / 32;
                var20 =
                    2 + 4 * (var27.anInt1347 - GlobalStatics_9.REGION_BASE_Y)
                        - GlobalStatics_9.localPlayer.sceneY / 32;
                this.draw(null, var20, var15, var29, var6, var11, 2047, var1,
                    var8, var5, var4,
                    var2, var27.anInt1355, var3, var7);
              }
              ...
              if (var27.anInt1360 == 10 && var27.anInt1359 >= 0
                ...
                if (var28 != null) {
                  var20 = -(GlobalStatics_9.localPlayer.sceneX
                      / 32) + var28.sceneX / 32;
                  var21 = var28.sceneY
                      / 32 - GlobalStatics_9.localPlayer.sceneY / 32;
                  this.draw(null, var21, var15, var20, var6, var11, 2047, var1,
                      var8, var5, var4,
                      var2, var27.anInt1355, var3, var7);
                }
        ...
        var23 = null;
        if (!this.aBoolean3968 && this.anInt2842 != -1
            && this.anInt2805 != -1) {
        ...
        if (!this.aBoolean3968 && this.anObject2796 != null) {
          ...
          if (this.anInt2797 <= GlobalStatics_4.updateCycle
            ...
            var25.method1897(this.anInt2782 - this.sceneX, this.anInt2812
                    - this.anInt2831,
                this.anInt2833 - this.sceneY);
        ...
        if (GlRenderer.USE_OPENGL) {
          ...
          if (var23 != null) {
            ...
            var23.draw(var1, var2, var3, var4, var5, var6, var7, var8, var9,
                var11
            );
          }
        } else {
