...
public final class FileSystem {
  ...
  public boolean isUpdateTableReceived() {
    if (this.updateTableBuffer == null) {
      ...
      if (this.updateTableRequest.aBoolean3632) {
        ...
        this.updateTableBuffer = new Buffer(
            this.updateTableRequest.method587(false));
        this.fileRequesters = new FileRequester[
            (this.updateTableBuffer.bytes.length - 5) / 8];
        return true;
      }
    } else {
      return true;
  ...
  public FileRequester method839(int var1, int var2, FileCache var3,
      FileCache var4) {
    if (var1 != -1824885439) {
  ...
  private FileRequester method847(FileCache var1, int var2, int var3,
      boolean var4,
      FileCache var5) {
    if (this.updateTableBuffer != null) {
      ...
      if (var2 >= -1) {
        return null;
      } else if (this.updateTableBuffer.bytes.length
          > this.updateTableBuffer.position) {
