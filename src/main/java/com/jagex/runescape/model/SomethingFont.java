...
public final class SomethingFont {
  ...
  private void method1001(int var1, int var2, int var3, int var4, byte[] var5) {
    ...
    int var11 = var6 + var7 * AbstractImageProducerStatics.anInt1092;
    int var12 = AbstractImageProducerStatics.anInt1092 - var8;
    int var13 = 0;
    int var14;
    if (var7 < AbstractImageProducerStatics.anInt1095) {
      var14 = AbstractImageProducerStatics.anInt1095 - var7;
      var9 -= var14;
      var7 = AbstractImageProducerStatics.anInt1095;
      var10 += var14 * var8;
      var11 += var14 * AbstractImageProducerStatics.anInt1092;
    }

    if (var7 + var9 >= AbstractImageProducerStatics.anInt1099) {
      var9 -= var7 + var9 - AbstractImageProducerStatics.anInt1099 + 1;
    }

    if (var6 < AbstractImageProducerStatics.anInt1093) {
      var14 = AbstractImageProducerStatics.anInt1093 - var6;
      var8 -= var14;
      var6 = AbstractImageProducerStatics.anInt1093;
      var10 += var14;
      var11 += var14;
      var13 += var14;
      var12 += var14;
    ...
    if (var6 + var8 >= AbstractImageProducerStatics.anInt1096) {
      var14 = var6 + var8 - AbstractImageProducerStatics.anInt1096 + 1;
      var8 -= var14;
      var13 += var14;
      var12 += var14;
    }
    ...
    if (var8 > 0 && var9 > 0) {
      if (this.aBoolean595) {
        this.method1000(AbstractImageProducerStatics.anIntArray1100, var5,
            var4, var10, var11, var8, var9, var12,
            var13);
      } else {
        this.method1002(AbstractImageProducerStatics.anIntArray1100, var5,
            var4, var10, var11, var8, var9, var12,
            var13);
      }
    }
  ...
  public void method1003(GameString var1, int var2, int var3, int var4,
    ...
    if (var2 - var6 <= AbstractImageProducerStatics.anInt1096) {
      if (var2 + var6 >= AbstractImageProducerStatics.anInt1093) {
        if (var3 - var7 <= AbstractImageProducerStatics.anInt1099) {
          if (var3 >= 0) {
