...
public final class OndemandRequester {
    ...
    if (this.socketStream == null) {
      ...
      try {
        ...
        for (
            ...
            var21 != null;
            var21 = (OndemandFileRequest) this.aClass13_993.getNext()) {
        ...
        for (
            ...
            var21 != null;
            var21 = (OndemandFileRequest) this.aClass13_1001.getNext()) {
          this.buffer.position = 0;
          ...
          if (read <= 0) {
            ...
            if (this.encryptionKey != 0) {
              for (var7 = 0; var7 < var6; ++var7) {
                this.aClass3_Sub30_1008.bytes[var7
                    + this.aClass3_Sub30_1008.position] =
                    (byte) GlobalStatics_9.bitXor(
                        this.aClass3_Sub30_1008.bytes[var7
                            + this.aClass3_Sub30_1008.position],
                        this.encryptionKey);
            ...
            if (this.aClass3_Sub30_1008.position >= read) {
              if (this.currentRequest != null) {
                ...
                this.currentRequest.buffer =
                    new Buffer(
                        length - (-var16 - this.currentRequest.aByte4064));
  ...
  public void setSocket(boolean var1, SocketStream var2) {
    ...
    while (true) {
      OndemandFileRequest var4 = (OndemandFileRequest) this.priorityRequests
          .poll();
      if (var4 == null) {
        while (true) {
