...
public final class MidiInstrument extends Node {
  ...
  public SomethingMusic0 method359(int[] var1 ) {
    if (var1 != null && var1[0] <= 0) {
      ...
      if (this.aByteArray2415 == null) {
        this.anInt2389 = 0;
        this.aFloatArray2394 = new float[GlobalStatics_11.anInt2396];
  ...
  private float[] method366(int var1) {
    GlobalStatics_11.method365(this.aByteArrayArray2410[var1], 0);
    GlobalStatics_11.method364();
    int var2 = GlobalStatics_11.method368(GlobalStatics_9.method513(
        GlobalStatics_11.anIntArray2420.length - 1, 4));
    boolean var3 = GlobalStatics_11.aBooleanArray2393[var2];
    int var4 = var3 ? GlobalStatics_11.anInt2396 : GlobalStatics_11.anInt2402;
    boolean var5 = false;
    boolean var6 = false;
    if (var3) {
      var5 = GlobalStatics_11.method364() != 0;
      var6 = GlobalStatics_11.method364() != 0;
    }
    ...
    int var10;
    if (var3 && !var5) {
      var8 = (var4 >> 2) - (GlobalStatics_11.anInt2402 >> 2);
      var9 = (var4 >> 2) + (GlobalStatics_11.anInt2402 >> 2);
      var10 = GlobalStatics_11.anInt2402 >> 1;
    } else {
      var8 = 0;
      var9 = var7;
      var10 = var4 >> 1;
    ...
    int var13;
    if (var3 && !var6) {
      var11 = var4 - (var4 >> 2) - (GlobalStatics_11.anInt2402 >> 2);
      var12 = var4 - (var4 >> 2) + (GlobalStatics_11.anInt2402 >> 2);
      var13 = GlobalStatics_11.anInt2402 >> 1;
    } else {
      var11 = var7;
      var12 = var4;
      var13 = var4 >> 1;
    ...
    SomethingMidiOther var14 = GlobalStatics_11.aClass150Array2398[GlobalStatics_11.anIntArray2420[var2]];
    int var16 = var14.anInt1928;
    int var17 = var14.anIntArray1929[var16];
    boolean var15 = !GlobalStatics_11.aClass59Array2407[var17].method1205();
    boolean var40 = var15;

    for (var17 = 0; var17 < var14.anInt1931; ++var17) {
      SomethingMidik var18 = GlobalStatics_11.aClass152Array2392[var14.anIntArray1930[var17]];
      float[] var19 = GlobalStatics_11.aFloatArray2403;
    ...
    if (!var15) {
      ...
      GlobalStatics_11.aClass59Array2407[var44].method1202(
          GlobalStatics_11.aFloatArray2403, var4 >> 1);
    }

    int var41;
    if (var15) {
      for (var17 = var4 >> 1; var17 < var4; ++var17) {
        GlobalStatics_11.aFloatArray2403[var17] = 0.0F;
      }
    } else {
      var17 = var4 >> 1;
      var44 = var4 >> 2;
      var41 = var4 >> 3;
      float[] var20 = GlobalStatics_11.aFloatArray2403;
      ...
      float[] var46 = var3 ? GlobalStatics_11.aFloatArray2399 : GlobalStatics_11.aFloatArray2400;
      float[] var22 = var3 ? GlobalStatics_11.aFloatArray2387 : GlobalStatics_11.aFloatArray2413;
      float[] var23 = var3 ? GlobalStatics_11.aFloatArray2388 : GlobalStatics_11.aFloatArray2416;
      int[] var24 = var3 ? GlobalStatics_11.anIntArray2409 : GlobalStatics_11.anIntArray2391;
      ...
      for (var49 = var8; var49 < var9; ++var49) {
        ...
        GlobalStatics_11.aFloatArray2403[var49] *=
    ...
    if (this.anInt2389 > 0) {
      ...
      if (!var15) {
        for (var41 = var8; var41 < var4 >> 1; ++var41) {
          ...
          var42[var45] += GlobalStatics_11.aFloatArray2403[var41];
        }
      }
    }

    float[] var43 = this.aFloatArray2394;
    this.aFloatArray2394 = GlobalStatics_11.aFloatArray2403;
    GlobalStatics_11.aFloatArray2403 = var43;
    this.anInt2389 = var4;
