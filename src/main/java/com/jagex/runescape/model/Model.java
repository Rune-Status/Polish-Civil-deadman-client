...
public final class Model extends SceneNode {
  ...
  private void rotateZ(int angle) {
    int sine = GlobalStatics_10.SINE_TABLE[angle];
    int cosine = GlobalStatics_10.COSINE_TABLE[angle];
            ...
            if (var14 >= var6.minimumZ && var14 <= var6.maximumZ) {
              for (int var15 = 0; var15 < var9; ++var15) {
                ...
                if (var13 == var8[var15] && var14 == var6.vz[var15] && var12 == var6.vy[var15]
                  ...
                  var18.c += var11.c;
                  ++var7;
                  GlobalStatics_10.anIntArray2861[var10] = GlobalStatics_10.anInt2868;
                  GlobalStatics_10.anIntArray2875[var15] = GlobalStatics_10.anInt2868;
                }
              }
            }
          }
  ...
  private void method1996(int[][] var1, int var2, int var3, int var4, int var5, int var6) {
    ...
    int var10 = -var5 / 2;
    int var11 = -var6 / 2;
    int var12 = GlobalStatics_10.method2009(var1, var2 + var10, var4 + var11);
    int var13 = var5 / 2;
    int var14 = -var6 / 2;
    int var15 = GlobalStatics_10.method2009(var1, var2 + var13, var4 + var14);
    int var16 = -var5 / 2;
    int var17 = var6 / 2;
    int var18 = GlobalStatics_10.method2009(var1, var2 + var16, var4 + var17);
    int var19 = var5 / 2;
    int var20 = var6 / 2;
    int var21 = GlobalStatics_10.method2009(var1, var2 + var19, var4 + var20);
  ...
  public void rotate(int rotationX, int rotationY, int rotationZ ) {
    ...
    int var7;
    if (rotationZ != 0) {
      var4 = GlobalStatics_10.SINE_TABLE[rotationZ];
      var5 = GlobalStatics_10.COSINE_TABLE[rotationZ];
    ...
    if (rotationX != 0) {
      var4 = GlobalStatics_10.SINE_TABLE[rotationX];
      var5 = GlobalStatics_10.COSINE_TABLE[rotationX];
    ...
    if (rotationY != 0) {
      var4 = GlobalStatics_10.SINE_TABLE[rotationY];
      var5 = GlobalStatics_10.COSINE_TABLE[rotationY];
