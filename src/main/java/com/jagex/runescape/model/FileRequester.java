...
public final class FileRequester extends AbstractFileRequester {
  ...
  public void method2107(boolean var1) {
    if (var1) {
      ...
      if (this.aBoolean2968 && this.aLong2967 <= TimeUtilities
          .getCurrentTimeMillis()) {
        for (
            AbstractFileRequest var6 = (AbstractFileRequest) this.aClass130_2946
                .getFirst(71);
            var6 != null;
            var6 = (AbstractFileRequest) this.aClass130_2946.getNext(-115)) {
  ...
  private AbstractFileRequest method2109(int var1, int var2, int var3) {
    ...
    if (((AbstractFileRequest) var4).aBoolean3632) {
      ...
      if (var4 instanceof FileCacheRequest) {
        ...
        var5[var5.length - 2] = (byte) (this.aClass62_2944.anIntArray958[var2]
            >>> 8);
