...
public final class ItemConfig {
  ...
  public ItemConfig() {
    ...
    this.anInt790 = 0;
    this.anInt778 = 0;
    this.inventoryOptions = new GameString[]{null, null, null, null,
        GlobalStatics_8.OPTION_DROP};
    this.anInt810 = 2000;
  ...
  public boolean method1102(boolean var1, boolean var2) {
    ...
    if (var3 == -1) {
      ...
      boolean var5 = true;
      if (!com.jagex.runescape.statics.GlobalStatics_0.aClass153_2581
          .method2129((byte) -75, 0, var3)) {
        var5 = false;
      }

      if (var4 != -1
          && !com.jagex.runescape.statics.GlobalStatics_0.aClass153_2581
          .method2129((byte) 58, 0, var4)) {
        var5 = false;
      }
  ...
  public AbstractModel getModel(int var1, int var2, int var3,
    ...
    if (var11 == null) {
        ...
        for (var9 = 0; this.aShortArray774.length > var9; ++var9) {
          if (this.aByteArray785 != null && var9 < this.aByteArray785.length) {
            var12.replaceColor(this.aShortArray774[var9],
                GlobalStatics_10.aShortArray3453[this.aByteArray785[var9]
                    & 255]);
          } else {
            var12.replaceColor(this.aShortArray774[var9],
      ...
      var11 = var12
          .method2008(this.anInt784 + 64, 768 + this.anInt790, -50, -10, -50);
  ...
  public Model method1117(boolean var1, int var2) {
    ...
    if (var3 == -1) {
      ...
      Model var6 = GlobalStatics_10
          .getModel(com.jagex.runescape.statics.GlobalStatics_0.aClass153_2581,
              var3, 0);
      if (var4 != -1) {
      ...
      if (this.aShortArray774 != null) {
        for (var11 = 0; var11 < this.aShortArray774.length; ++var11) {
          assert var6 != null;
          var6.replaceColor(this.aShortArray774[var11],
              this.aShortArray772[var11]);
        }
      }
    ...
    if (var2 == null) {
        ...
        for (var3 = 0; this.aShortArray774.length > var3; ++var3) {
          if (this.aByteArray785 != null && var3 < this.aByteArray785.length) {
            var2.replaceColor(this.aShortArray774[var3],
                GlobalStatics_10.aShortArray3453[this.aByteArray785[var3]
                    & 255]);
          } else {
            var2.replaceColor(this.aShortArray774[var3],
                this.aShortArray772[var3]);
          }
        }
      }
      ...
      if (this.aShortArray765 != null) {
        for (var3 = 0; var3 < this.aShortArray765.length; ++var3) {
          var2.replaceMaterial(this.aShortArray765[var3],
              this.aShortArray751[var3]);
        }
      }

      SoftwareModel var5 =
          var2.method2000(64 + this.anInt784, 768 + this.anInt790, -50, -10,
              -50);
      if (var1 != 18206) {
